...
<html>
<head>
  <title>setDataStreaming.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../../../doc-style.css" />
  <script src="../../../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/cylon-sphero/examples/setDataStreaming/setDataStreaming.js";
...
Cylon.robot({
  ...
  <span class="hljs-attr">work</span>: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">bot</span>) </span>{
...
<p>The data sources available for data Streaming from the
...
n = 200 means 400/200 = 2 data samples per second</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      n: <span class="hljs-number">40</span>,
</pre>
        </td>
      </tr>
...
pcnt = 10 means stop after 10 data packets</p>
      ...
      <span class="hljs-attr">dataSources</span>: [<span class="hljs-string">"velocity"</span>, <span class="hljs-string">"odomoter"</span>]
    };
