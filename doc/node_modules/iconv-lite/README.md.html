...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/iconv-lite/README.md";
...
str = iconv.decode(<span class="hljs-keyword">new</span> Buffer([<span class="hljs-number">0x68</span>, <span class="hljs-number">0x65</span>, <span class="hljs-number">0x6c</span>, <span class="hljs-number">0x6c</span>, <span class="hljs-number">0x6f</span>]), <span class="hljs-string">'win1251'</span>);
...
<li>All widespread multibyte encodings: CP932, CP936, CP949, CP950, GB2313, GBK, GB18030, Big5, Shift_JIS, EUC-JP.</li>
</ul>
...
<div class="pilwrap" id="adoption">
  <h2>
    <a href="#adoption" name="adoption" class="pilcrow"></a>
Adoption
  </h2>
</div>
<p><a href="https://nodei.co/npm/iconv-lite/"><img src="https://nodei.co/npm-dl/iconv-lite.png" alt="NPM"></a>
<a href="https://www.codeship.com/projects/29053"><img src="https://www.codeship.com/projects/81670840-fa72-0131-4520-4a01a6c01acc/status" alt="Codeship Status for ashtuchkin/iconv-lite"></a></p>
</div>
  </div>
</body>
</html>
