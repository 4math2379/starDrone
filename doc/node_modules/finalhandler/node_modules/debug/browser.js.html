...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/finalhandler/node_modules/debug/browser.js";
...
<p>is webkit? http://stackoverflow.com/a/16459606/376773</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> (<span class="hljs-string">'WebkitAppearance'</span> <span class="hljs-keyword">in</span> <span class="hljs-built_in">document</span>.documentElement.style) ||
</pre>
        </td>
      </tr>
...
<p>is firebug? http://stackoverflow.com/a/398120/376773</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    (<span class="hljs-built_in">window</span>.console &amp;&amp; (<span class="hljs-built_in">console</span>.firebug || (<span class="hljs-built_in">console</span>.exception &amp;&amp; <span class="hljs-built_in">console</span>.table))) ||
</pre>
        </td>
      </tr>
...
https://developer.mozilla.org/en-US/docs/Tools/Web_Console#Styling_messages</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    (navigator.userAgent.toLowerCase().match(<span class="hljs-regexp">/firefox\/(\d+)/</span>) &amp;&amp; <span class="hljs-built_in">parseInt</span>(<span class="hljs-built_in">RegExp</span>.$<span class="hljs-number">1</span>, <span class="hljs-number">10</span>) &gt;= <span class="hljs-number">31</span>);
}
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">formatArgs</span>(<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (!useColors) <span class="hljs-keyword">return</span> args;

  <span class="hljs-keyword">var</span> c = <span class="hljs-string">'color: '</span> + <span class="hljs-keyword">this</span>.color;
  args = [args[<span class="hljs-number">0</span>], c, <span class="hljs-string">'color: inherit'</span>].concat(<span class="hljs-built_in">Array</span>.prototype.slice.call(args, <span class="hljs-number">1</span>));
...
figure out the correct index to insert the CSS into</p>
  ...
  args[<span class="hljs-number">0</span>].replace(<span class="hljs-regexp">/%[a-z%]/g</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">match</span>) </span>{
