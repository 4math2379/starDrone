...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/qs/dist/qs.js";
...
<span class="hljs-keyword">var</span> defaults = {
    ...
    <span class="hljs-attr">decoder</span>: Utils.decode
};

<span class="hljs-keyword">var</span> parseValues = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parseValues</span>(<span class="hljs-params">str, options</span>) </span>{
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; parts.length; ++i) {
        ...
        <span class="hljs-keyword">if</span> (pos === <span class="hljs-number">-1</span>) {
            ...
            key = options.decoder(part.slice(<span class="hljs-number">0</span>, pos));
            val = options.decoder(part.slice(pos + <span class="hljs-number">1</span>));
        }
...
<span class="hljs-keyword">var</span> parseObject = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parseObject</span>(<span class="hljs-params">chain, val, options</span>) </span>{
...
<span class="hljs-keyword">var</span> parseKeys = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parseKeys</span>(<span class="hljs-params">givenKey, val, options</span>) </span>{
...
that would overwrite object prototype properties</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">if</span> (!options.plainObjects &amp;&amp; has.call(<span class="hljs-built_in">Object</span>.prototype, segment[<span class="hljs-number">1</span>])) {
...
<p>Loop through children appending to the array until we hit depth</p>
    ...
    <span class="hljs-keyword">while</span> ((segment = child.exec(key)) !== <span class="hljs-literal">null</span> &amp;&amp; i &lt; options.depth) {
        ...
        <span class="hljs-keyword">if</span> (!options.plainObjects &amp;&amp; has.call(<span class="hljs-built_in">Object</span>.prototype, segment[<span class="hljs-number">1</span>].replace(<span class="hljs-regexp">/\[|\]/g</span>, <span class="hljs-string">''</span>))) {
            <span class="hljs-keyword">if</span> (!options.allowPrototypes) {
...
<p>If there's a remainder, just add whatever is left</p>
    ...
    <span class="hljs-keyword">return</span> parseObject(keys, val, options);
};
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str, opts</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (options.decoder !== <span class="hljs-literal">null</span> &amp;&amp; options.decoder !== <span class="hljs-literal">undefined</span> &amp;&amp; <span class="hljs-keyword">typeof</span> options.decoder !== <span class="hljs-string">'function'</span>) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">'Decoder has to be a function.'</span>);
    }

    options.delimiter = <span class="hljs-keyword">typeof</span> options.delimiter === <span class="hljs-string">'string'</span> || Utils.isRegExp(options.delimiter) ? options.delimiter : defaults.delimiter;
    options.depth = <span class="hljs-keyword">typeof</span> options.depth === <span class="hljs-string">'number'</span> ? options.depth : defaults.depth;
    options.arrayLimit = <span class="hljs-keyword">typeof</span> options.arrayLimit === <span class="hljs-string">'number'</span> ? options.arrayLimit : defaults.arrayLimit;
    options.parseArrays = options.parseArrays !== <span class="hljs-literal">false</span>;
    options.decoder = <span class="hljs-keyword">typeof</span> options.decoder === <span class="hljs-string">'function'</span> ? options.decoder : defaults.decoder;
    options.allowDots = <span class="hljs-keyword">typeof</span> options.allowDots === <span class="hljs-string">'boolean'</span> ? options.allowDots : defaults.allowDots;
    options.plainObjects = <span class="hljs-keyword">typeof</span> options.plainObjects === <span class="hljs-string">'boolean'</span> ? options.plainObjects : defaults.plainObjects;
    options.allowPrototypes = <span class="hljs-keyword">typeof</span> options.allowPrototypes === <span class="hljs-string">'boolean'</span> ? options.allowPrototypes : defaults.allowPrototypes;
    options.parameterLimit = <span class="hljs-keyword">typeof</span> options.parameterLimit === <span class="hljs-string">'number'</span> ? options.parameterLimit : defaults.parameterLimit;
    options.strictNullHandling = <span class="hljs-keyword">typeof</span> options.strictNullHandling === <span class="hljs-string">'boolean'</span> ? options.strictNullHandling : defaults.strictNullHandling;

    <span class="hljs-keyword">if</span> (str === <span class="hljs-string">''</span> || str === <span class="hljs-literal">null</span> || <span class="hljs-keyword">typeof</span> str === <span class="hljs-string">'undefined'</span>) {
    ...
    <span class="hljs-keyword">var</span> tempObj = <span class="hljs-keyword">typeof</span> str === <span class="hljs-string">'string'</span> ? parseValues(str, options) : str;
...
<span class="hljs-keyword">var</span> arrayPrefixGenerators = {
    <span class="hljs-attr">brackets</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">brackets</span>(<span class="hljs-params">prefix</span>) </span>{
        <span class="hljs-keyword">return</span> prefix + <span class="hljs-string">'[]'</span>;
    },
    <span class="hljs-attr">indices</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">indices</span>(<span class="hljs-params">prefix, key</span>) </span>{
        <span class="hljs-keyword">return</span> prefix + <span class="hljs-string">'['</span> + key + <span class="hljs-string">']'</span>;
    },
    <span class="hljs-attr">repeat</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">repeat</span>(<span class="hljs-params">prefix</span>) </span>{
...
<span class="hljs-keyword">var</span> defaults = {
    ...
    <span class="hljs-attr">encoder</span>: Utils.encode
};

<span class="hljs-keyword">var</span> stringify = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">stringify</span>(<span class="hljs-params">object, prefix, generateArrayPrefix, strictNullHandling, skipNulls, encoder, filter, sort, allowDots</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> filter === <span class="hljs-string">'function'</span>) {
        ...
        <span class="hljs-keyword">if</span> (strictNullHandling) {
            <span class="hljs-keyword">return</span> encoder ? encoder(prefix) : prefix;
        }

        obj = <span class="hljs-string">''</span>;
    }

    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> obj === <span class="hljs-string">'string'</span> || <span class="hljs-keyword">typeof</span> obj === <span class="hljs-string">'number'</span> || <span class="hljs-keyword">typeof</span> obj === <span class="hljs-string">'boolean'</span> || Utils.isBuffer(obj)) {
        <span class="hljs-keyword">if</span> (encoder) {
            <span class="hljs-keyword">return</span> [encoder(prefix) + <span class="hljs-string">'='</span> + encoder(obj)];
        }
        <span class="hljs-keyword">return</span> [prefix + <span class="hljs-string">'='</span> + <span class="hljs-built_in">String</span>(obj)];
    }
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; objKeys.length; ++i) {
        ...
        <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Array</span>.isArray(obj)) {
            ...
            values = values.concat(stringify(obj[key], prefix + (allowDots ? <span class="hljs-string">'.'</span> + key : <span class="hljs-string">'['</span> + key + <span class="hljs-string">']'</span>), generateArrayPrefix, strictNullHandling, skipNulls, encoder, filter, sort, allowDots));
        }
    }
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">object, opts</span>) </span>{
    <span class="hljs-keyword">var</span> obj = object;
    <span class="hljs-keyword">var</span> options = opts || {};
    <span class="hljs-keyword">var</span> delimiter = <span class="hljs-keyword">typeof</span> options.delimiter === <span class="hljs-string">'undefined'</span> ? defaults.delimiter : options.delimiter;
    <span class="hljs-keyword">var</span> strictNullHandling = <span class="hljs-keyword">typeof</span> options.strictNullHandling === <span class="hljs-string">'boolean'</span> ? options.strictNullHandling : defaults.strictNullHandling;
    <span class="hljs-keyword">var</span> skipNulls = <span class="hljs-keyword">typeof</span> options.skipNulls === <span class="hljs-string">'boolean'</span> ? options.skipNulls : defaults.skipNulls;
    <span class="hljs-keyword">var</span> encode = <span class="hljs-keyword">typeof</span> options.encode === <span class="hljs-string">'boolean'</span> ? options.encode : defaults.encode;
    <span class="hljs-keyword">var</span> encoder = encode ? (<span class="hljs-keyword">typeof</span> options.encoder === <span class="hljs-string">'function'</span> ? options.encoder : defaults.encoder) : <span class="hljs-literal">null</span>;
    ...
    <span class="hljs-keyword">if</span> (options.encoder !== <span class="hljs-literal">null</span> &amp;&amp; options.encoder !== <span class="hljs-literal">undefined</span> &amp;&amp; <span class="hljs-keyword">typeof</span> options.encoder !== <span class="hljs-string">'function'</span>) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">'Encoder has to be a function.'</span>);
    }
    ...
    <span class="hljs-keyword">if</span> (options.arrayFormat <span class="hljs-keyword">in</span> arrayPrefixGenerators) {
    ...
    <span class="hljs-keyword">var</span> generateArrayPrefix = arrayPrefixGenerators[arrayFormat];
...
exports.compact = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">obj, references</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Array</span>.isArray(obj)) {
        ...
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; obj.length; ++i) {
            ...
            } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> obj[i] !== <span class="hljs-string">'undefined'</span>) {
