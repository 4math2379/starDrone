...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/destroy/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#destroy-stream">destroy(stream)</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="destroy">
  <h1>
...
<a href="LICENSE.md.html"><img src="http://img.shields.io/npm/l/destroy.svg?style=flat-square" alt="License"></a>
...
<div class="pilwrap" id="destroy-stream">
  <h3>
    <a href="#destroy-stream" name="destroy-stream" class="pilcrow"></a>
destroy(stream)
  </h3>
</div>
