...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/content-type/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#contenttype.parse-string">contentType.parse(string)</a>
      </div>

      <div class="heading h3">
        <a href="#contenttype.parse-req">contentType.parse(req)</a>
      </div>

      <div class="heading h3">
        <a href="#contenttype.parse-res">contentType.parse(res)</a>
      </div>

      <div class="heading h3">
        <a href="#contenttype.format-obj">contentType.format(obj)</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="content-type">
  <h1>
    <a href="#content-type" name="content-type" class="pilcrow"></a>
content-type
  </h1>
</div>
...
<pre><code class="sh">$ npm install content-type
</code></pre>
...
<div class="pilwrap" id="contenttype.parse-string">
  <h3>
    <a href="#contenttype.parse-string" name="contenttype.parse-string" class="pilcrow"></a>
contentType.parse(string)
  </h3>
</div>
<pre><code class="js"><span class="hljs-keyword">var</span> obj = contentType.parse(<span class="hljs-string">'image/svg+xml; charset=utf-8'</span>)
</code></pre>
...
<div class="pilwrap" id="contenttype.parse-req">
  <h3>
    <a href="#contenttype.parse-req" name="contenttype.parse-req" class="pilcrow"></a>
contentType.parse(req)
  </h3>
</div>
<pre><code class="js"><span class="hljs-keyword">var</span> obj = contentType.parse(req)
</code></pre>
...
<div class="pilwrap" id="contenttype.parse-res">
  <h3>
    <a href="#contenttype.parse-res" name="contenttype.parse-res" class="pilcrow"></a>
contentType.parse(res)
  </h3>
</div>
<pre><code class="js"><span class="hljs-keyword">var</span> obj = contentType.parse(res)
</code></pre>
...
<p>Throws a <code>TypeError</code> if the <code>Content-Type</code> header is missing or invalid.</p>
<div class="pilwrap" id="contenttype.format-obj">
  <h3>
    <a href="#contenttype.format-obj" name="contenttype.format-obj" class="pilcrow"></a>
contentType.format(obj)
  </h3>
</div>
<pre><code class="js"><span class="hljs-keyword">var</span> str = contentType.format({<span class="hljs-attr">type</span>: <span class="hljs-string">'image/svg+xml'</span>})
</code></pre>
