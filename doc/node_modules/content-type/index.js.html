...
quoted-pair   = &quot;&quot; ( HTAB / SP / VCHAR / obs-text )</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> paramRegExp = <span class="hljs-regexp">/; *([!#$%&amp;'\*\+\-\.\^_`\|~0-9A-Za-z]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&amp;'\*\+\-\.\^_`\|~0-9A-Za-z]+) */g</span>
<span class="hljs-keyword">var</span> textRegExp = <span class="hljs-regexp">/^[\u000b\u0020-\u007e\u0080-\u00ff]+$/</span>
<span class="hljs-keyword">var</span> tokenRegExp = <span class="hljs-regexp">/^[!#$%&amp;'\*\+\-\.\^_`\|~0-9A-Za-z]+$/</span>
...
obs-text    = %x80-FF</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> qescRegExp = <span class="hljs-regexp">/\\([\u000b\u0020-\u00ff])/g</span>
...
subtype    = token</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> typeRegExp = <span class="hljs-regexp">/^[!#$%&amp;'\*\+\-\.\^_`\|~0-9A-Za-z]+\/[!#$%&amp;'\*\+\-\.\^_`\|~0-9A-Za-z]+$/</span>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">format</span>(<span class="hljs-params">obj</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (!type || !typeRegExp.test(type)) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse</span>(<span class="hljs-params">string</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> string === <span class="hljs-string">'object'</span>) {
</pre>
        </td>
      </tr>
...
<p>support req/res-like objects as argument</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    string = getcontenttype(string)
  ...
  <span class="hljs-keyword">var</span> type = index !== <span class="hljs-number">-1</span>
    ? string.substr(<span class="hljs-number">0</span>, index).trim()
    : string.trim()

  <span class="hljs-keyword">if</span> (!typeRegExp.test(type)) {
