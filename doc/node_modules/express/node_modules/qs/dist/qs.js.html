...
<head>
  ...
  <script>
    var relativeDir = "../../../../../";
    var thisFile = "node_modules/express/node_modules/qs/dist/qs.js";
...
<span class="hljs-keyword">var</span> parseValues = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parseValues</span>(<span class="hljs-params">str, options</span>) </span>{
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; parts.length; ++i) {
        ...
        <span class="hljs-keyword">if</span> (pos === <span class="hljs-number">-1</span>) {
            obj[options.decoder(part)] = <span class="hljs-string">''</span>;

            <span class="hljs-keyword">if</span> (options.strictNullHandling) {
                obj[options.decoder(part)] = <span class="hljs-literal">null</span>;
            }
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">var</span> key = options.decoder(part.slice(<span class="hljs-number">0</span>, pos));
            <span class="hljs-keyword">var</span> val = options.decoder(part.slice(pos + <span class="hljs-number">1</span>));
