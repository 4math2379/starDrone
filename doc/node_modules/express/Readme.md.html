...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/express/Readme.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#docs-and-community">Docs &amp;amp; Community</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><p><a href="http://expressjs.com/"><img src="https://i.cloudup.com/zfY6lL7eFa-3000x3000.png" alt="Express Logo"></a></p>
...
<div class="pilwrap" id="docs-and-community">
  <h2>
    <a href="#docs-and-community" name="docs-and-community" class="pilcrow"></a>
Docs &amp; Community
  </h2>
</div>
<ul>
<li><a href="http://expressjs.com/">Website and Documentation</a> - [<a href="https://github.com/strongloop/expressjs.com">website repo</a>]</li>
...
<p>###Security Issues</p>
<p>If you discover a security vulnerability in Express, please see <a href="Security.md.html">Security Policies and Procedures</a>.</p>
...
<pre><code class="bash">$ npm install -g express-generator@4
</code></pre>
<p>Create the app:</p>
<pre><code class="bash">$ express /tmp/foo &amp;&amp; <span class="hljs-built_in">cd</span> /tmp/foo
</code></pre>
...
<div class="pilwrap" id="philosophy">
  <h2>
    <a href="#philosophy" name="philosophy" class="pilcrow"></a>
Philosophy
  </h2>
</div>
...
<pre><code class="bash">$ git <span class="hljs-built_in">clone</span> git://github.com/expressjs/express.git --depth 1
$ <span class="hljs-built_in">cd</span> express
$ npm install
</code></pre>
<p>Then run whichever example you want:</p>
<pre><code class="bash">$ node examples/content-negotiation
</code></pre>
