...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/methods/README.md";
...
<body>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="methods">
  <h1>
...
<pre><code class="bash">$ npm install methods
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">var</span> methods = <span class="hljs-built_in">require</span>(<span class="hljs-string">'methods'</span>)
</code></pre>
