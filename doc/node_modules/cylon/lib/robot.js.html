...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/cylon/lib/robot.js";
...
<span>the robot
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-string">"adapter"</span> <span class="hljs-keyword">in</span> conn) {
...
<span class="dox_tag_name"></span>
  ...
  <span class="hljs-keyword">this</span>[connection.name] = connection;
