...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/http-errors/index.js";
...
<p>so much arity going on ~_~</p>
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> status !== <span class="hljs-string">'number'</span> || !statuses[status]) {
...
<p>constructor</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> HttpError = createError[status]
...
<p>create error</p>
  ...
  <span class="hljs-keyword">if</span> (!HttpError || !(err <span class="hljs-keyword">instanceof</span> HttpError)) {
</pre>
        </td>
      </tr>
...
<p>create the error object</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> err = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(message != <span class="hljs-literal">null</span> ? message : statuses[code])
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">populateConstructorExports</span> (<span class="hljs-params">exports, codes, HttpError</span>) </span>{
  codes.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">forEachCode</span> (<span class="hljs-params">code</span>) </span>{
    ...
    <span class="hljs-keyword">switch</span> (<span class="hljs-built_in">String</span>(code).charAt(<span class="hljs-number">0</span>)) {
...
<p>backwards-compatibility</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  exports[<span class="hljs-string">"I'mateapot"</span>] = exports.ImATeapot
}
