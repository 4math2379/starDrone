...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/balanced-match/index.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-built_in">module</span>.exports = balanced;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">range</span>(<span class="hljs-params">a, b, str</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (ai &gt;= <span class="hljs-number">0</span> &amp;&amp; bi &gt; <span class="hljs-number">0</span>) {
    ...
    <span class="hljs-keyword">while</span> (i &lt; str.length &amp;&amp; i &gt;= <span class="hljs-number">0</span> &amp;&amp; ! result) {
