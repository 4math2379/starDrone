...
<head>
  ...
  <script>
    var relativeDir = "../../../../../";
    var thisFile = "node_modules/serialport/node_modules/tar/test/pack.js";
...
included.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    [ [ <span class="hljs-string">'globalExtendedHeader'</span>,
      { <span class="hljs-attr">path</span>: <span class="hljs-string">'PaxHeader/'</span>,
        ...
        <span class="hljs-attr">type</span>: <span class="hljs-string">'g'</span>,
      ...
      { <span class="hljs-string">"NODETAR.author"</span>: pkg.author,
        <span class="hljs-string">"NODETAR.name"</span>: pkg.name,
        <span class="hljs-string">"NODETAR.description"</span>: pkg.description,
        <span class="hljs-string">"NODETAR.version"</span>: pkg.version,
        <span class="hljs-string">"NODETAR.repository.type"</span>: pkg.repository.type,
        <span class="hljs-string">"NODETAR.repository.url"</span>: pkg.repository.url,
        <span class="hljs-string">"NODETAR.main"</span>: pkg.main,
        <span class="hljs-string">"NODETAR.scripts.test"</span>: pkg.scripts.test } ]
    ...
    , [ <span class="hljs-string">'extendedHeader'</span>,
      ...
      { <span class="hljs-attr">path</span>: <span class="hljs-string">'fixtures/200ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'</span>,
        <span class="hljs-string">'NODETAR.depth'</span>: <span class="hljs-string">'1'</span>,
        <span class="hljs-string">'NODETAR.type'</span>: <span class="hljs-string">'File'</span>,
        ...
        <span class="hljs-string">'NODETAR.blksize'</span>: <span class="hljs-string">'4096'</span>,
        <span class="hljs-string">'NODETAR.blocks'</span>: <span class="hljs-string">'8'</span> } ]
    ...
    , [ <span class="hljs-string">'extendedHeader'</span>,
      ...
      { <span class="hljs-attr">path</span>: <span class="hljs-string">'fixtures/packtest/Ω.txt'</span>,
        <span class="hljs-string">'NODETAR.depth'</span>: <span class="hljs-string">'2'</span>,
        <span class="hljs-string">'NODETAR.type'</span>: <span class="hljs-string">'File'</span>,
        <span class="hljs-attr">nlink</span>: <span class="hljs-number">1</span>,
        <span class="hljs-attr">uid</span>: uid,
        <span class="hljs-attr">gid</span>: gid,
...
tap.test(<span class="hljs-string">"with from base"</span>, { <span class="hljs-attr">timeout</span>: <span class="hljs-number">10000</span> }, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">t</span>) </span>{
  runTest(t, <span class="hljs-literal">true</span>, <span class="hljs-literal">true</span>)
})
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">runTest</span> (<span class="hljs-params">t, doGH, doFromBase</span>) </span>{
  ...
  <span class="hljs-keyword">if</span>(doFromBase) props.fromBase = <span class="hljs-literal">true</span>;
...
<p>skip the global header if we're not doing that.</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> entry = doGH ? <span class="hljs-number">0</span> : <span class="hljs-number">1</span>
...
<p>console.error(&quot;PACK END&quot;)</p>
  ...
  parse.on(<span class="hljs-string">"*"</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">ev, e</span>) </span>{
    ...
    <span class="hljs-keyword">if</span>(doFromBase) {
      <span class="hljs-keyword">if</span>(wanted[<span class="hljs-number">1</span>].path.indexOf(<span class="hljs-string">'fixtures/'</span>) &amp;&amp; wanted[<span class="hljs-number">1</span>].path.length == <span class="hljs-number">100</span>)
        wanted[<span class="hljs-number">1</span>].path = wanted[<span class="hljs-number">1</span>].path.replace(<span class="hljs-string">'fixtures/'</span>, <span class="hljs-string">''</span>) + <span class="hljs-string">'ccccccccc'</span>

      <span class="hljs-keyword">if</span>(wanted[<span class="hljs-number">1</span>]) wanted[<span class="hljs-number">1</span>].path = wanted[<span class="hljs-number">1</span>].path.replace(<span class="hljs-string">'fixtures/'</span>, <span class="hljs-string">''</span>).replace(<span class="hljs-string">'//'</span>, <span class="hljs-string">'/'</span>)
      <span class="hljs-keyword">if</span>(wanted[<span class="hljs-number">1</span>].path == <span class="hljs-string">''</span>) wanted[<span class="hljs-number">1</span>].path = <span class="hljs-string">'/'</span>
      <span class="hljs-keyword">if</span>(wanted[<span class="hljs-number">2</span>] &amp;&amp; wanted[<span class="hljs-number">2</span>].path) wanted[<span class="hljs-number">2</span>].path = wanted[<span class="hljs-number">2</span>].path.replace(<span class="hljs-string">'fixtures'</span>, <span class="hljs-string">''</span>).replace(<span class="hljs-regexp">/^\//</span>, <span class="hljs-string">''</span>)

      wanted[<span class="hljs-number">1</span>].linkpath = wanted[<span class="hljs-number">1</span>].linkpath.replace(<span class="hljs-string">'fixtures/'</span>, <span class="hljs-string">''</span>)
    }
