...
<head>
  ...
  <script>
    var relativeDir = "../../../../../../../";
    var thisFile = "node_modules/serialport/node_modules/tar-pack/node_modules/readable-stream/lib/_stream_duplex.js";
...
<p>a duplex stream is just a stream that is both readable and writable.
...
<p>/<em><replacement></em>/</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> processNextTick = <span class="hljs-built_in">require</span>(<span class="hljs-string">'process-nextick-args'</span>);
</pre>
        </td>
      </tr>
