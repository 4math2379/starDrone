...
<head>
  ...
  <script>
    var relativeDir = "../../../../../";
    var thisFile = "node_modules/serialport/node_modules/sshpk/bin/sshpk-conv";
...
<div class="body">
	...
	<span class="hljs-keyword">try</span> {
		...
		<span class="hljs-built_in">console</span>.error(<span class="hljs-string">'sshpk-conv: error opening input file'</span> +
	...
	<span class="hljs-keyword">try</span> {
		...
		<span class="hljs-built_in">console</span>.error(<span class="hljs-string">'sshpk-conv: error opening output file'</span> +
		    <span class="hljs-string">': '</span> + e.name + <span class="hljs-string">': '</span> + e.message);
		process.exit(<span class="hljs-number">1</span>);
	}
	...
	inFile.on(<span class="hljs-string">'end'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">processKey</span>(<span class="hljs-params"></span>) </span>{
		...
		<span class="hljs-keyword">try</span> {
			...
			<span class="hljs-built_in">console</span>.error(<span class="hljs-string">'sshpk-conv: '</span> +
		...
		<span class="hljs-keyword">if</span> (!opts.identify) {
			...
			<span class="hljs-built_in">console</span>.log(<span class="hljs-string">'Fingerprint:'</span>);
			<span class="hljs-built_in">console</span>.log(<span class="hljs-string">'  '</span> + key.fingerprint().toString());
			<span class="hljs-built_in">console</span>.log(<span class="hljs-string">'  '</span> + key.fingerprint(<span class="hljs-string">'md5'</span>).toString());
			process.exit(<span class="hljs-number">0</span>);
		}
	});
}
