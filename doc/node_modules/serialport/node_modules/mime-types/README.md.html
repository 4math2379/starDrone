...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/mime-types/README.md";
...
<ul>
<li><strong>No fallbacks.</strong> Instead of naively returning the first available type, <code>mime-types</code> simply returns <code>false</code>,
so do <code>var type = mime.lookup('unrecognized') || 'application/octet-stream'</code>.</li>
...
mime.lookup(<span class="hljs-string">'.md'</span>)              <span class="hljs-comment">// 'text/x-markdown'</span>
...
<pre><code class="js">mime.charset(<span class="hljs-string">'text/x-markdown'</span>) <span class="hljs-comment">// 'UTF-8'</span>
</code></pre>
