...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/mime-types/index.js";
...
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> extractTypeRegExp = <span class="hljs-regexp">/^\s*([^;\s]*)(?:;|\s|$)/</span>
<span class="hljs-keyword">var</span> textTypeRegExp = <span class="hljs-regexp">/^text\//i</span>
...
<p>TODO: use media-typer</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> match = extractTypeRegExp.exec(type)
...
<p>default text/* to utf-8</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (match &amp;&amp; textTypeRegExp.test(match[<span class="hljs-number">1</span>])) {
