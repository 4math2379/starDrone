...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/aws4/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#aws4.sign-requestoptions-credentials">aws4.sign(requestOptions, [credentials])</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="aws4">
  <h2>
    <a href="#aws4" name="aws4" class="pilcrow"></a>
aws4
  </h2>
</div>
...
<p>Can also be used <a href="./browser.html">in the browser</a>.</p>
...
<div class="pilwrap" id="more-options">
  <h2>
    <a href="#more-options" name="more-options" class="pilcrow"></a>
More options
  </h2>
</div>
<pre><code class="javascript"><span class="hljs-comment">// you can also pass AWS credentials in explicitly (otherwise taken from process.env)</span>
...
<div class="pilwrap" id="aws4.sign-requestoptions-credentials">
  <h3>
    <a href="#aws4.sign-requestoptions-credentials" name="aws4.sign-requestoptions-credentials" class="pilcrow"></a>
...
<pre><code class="javascript">aws4.sign(requestOptions, {
