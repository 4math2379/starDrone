...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/semver/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#semver-1-the-semantic-versioner-for-npm">semver(1) -- The semantic versioner for npm</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#prerelease-tags">Prerelease Tags</a>
      </div>

      <div class="heading h4">
        <a href="#prerelease-identifiers">Prerelease Identifiers</a>
      </div>

      <div class="heading h3">
        <a href="#advanced-range-syntax">Advanced Range Syntax</a>
      </div>

      <div class="heading h4">
        <a href="#hyphen-ranges-x.y.z-a.b.c">Hyphen Ranges X.Y.Z - A.B.C</a>
      </div>

      <div class="heading h4">
        <a href="#x-ranges-1.2.x-1.x-1.2.*-*">X-Ranges 1.2.x 1.X 1.2.* *</a>
      </div>

      <div class="heading h4">
        <a href="#tilde-ranges-~1.2.3-~1.2-~1">Tilde Ranges ~1.2.3 ~1.2 ~1</a>
      </div>

      <div class="heading h4">
        <a href="#caret-ranges-1.2.3-0.2.5-0.0.4">Caret Ranges ^1.2.3 ^0.2.5 ^0.0.4</a>
      </div>

      <div class="heading h3">
        <a href="#range-grammar">Range Grammar</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="semver-1-the-semantic-versioner-for-npm">
  <h1>
    <a href="#semver-1-the-semantic-versioner-for-npm" name="semver-1-the-semantic-versioner-for-npm" class="pilcrow"></a>
...
<div class="pilwrap" id="versions">
  <h2>
    <a href="#versions" name="versions" class="pilcrow"></a>
Versions
  </h2>
</div>
...
<div class="pilwrap" id="ranges">
  <h2>
    <a href="#ranges" name="ranges" class="pilcrow"></a>
Ranges
  </h2>
</div>
...
<div class="pilwrap" id="prerelease-tags">
  <h3>
    <a href="#prerelease-tags" name="prerelease-tags" class="pilcrow"></a>
Prerelease Tags
  </h3>
</div>
...
<div class="pilwrap" id="prerelease-identifiers">
  <h4>
    <a href="#prerelease-identifiers" name="prerelease-identifiers" class="pilcrow"></a>
...
<pre><code class="javascript">&gt; semver.inc(<span class="hljs-string">'1.2.3'</span>, <span class="hljs-string">'prerelease'</span>, <span class="hljs-string">'beta'</span>)
<span class="hljs-string">'1.2.4-beta.0'</span>
</code></pre>
...
<div class="pilwrap" id="advanced-range-syntax">
  <h3>
    <a href="#advanced-range-syntax" name="advanced-range-syntax" class="pilcrow"></a>
...
<div class="pilwrap" id="hyphen-ranges-x.y.z-a.b.c">
  <h4>
    <a href="#hyphen-ranges-x.y.z-a.b.c" name="hyphen-ranges-x.y.z-a.b.c" class="pilcrow"></a>
Hyphen Ranges <code>X.Y.Z - A.B.C</code>
  </h4>
</div>
...
<div class="pilwrap" id="x-ranges-1.2.x-1.x-1.2.*-*">
  <h4>
    <a href="#x-ranges-1.2.x-1.x-1.2.*-*" name="x-ranges-1.2.x-1.x-1.2.*-*" class="pilcrow"></a>
X-Ranges <code>1.2.x</code> <code>1.X</code> <code>1.2.*</code> <code>*</code>
  </h4>
</div>
...
<div class="pilwrap" id="tilde-ranges-~1.2.3-~1.2-~1">
  <h4>
    <a href="#tilde-ranges-~1.2.3-~1.2-~1" name="tilde-ranges-~1.2.3-~1.2-~1" class="pilcrow"></a>
Tilde Ranges <code>~1.2.3</code> <code>~1.2</code> <code>~1</code>
  </h4>
</div>
...
<div class="pilwrap" id="caret-ranges-1.2.3-0.2.5-0.0.4">
  <h4>
    <a href="#caret-ranges-1.2.3-0.2.5-0.0.4" name="caret-ranges-1.2.3-0.2.5-0.0.4" class="pilcrow"></a>
Caret Ranges <code>^1.2.3</code> <code>^0.2.5</code> <code>^0.0.4</code>
  </h4>
</div>
...
<div class="pilwrap" id="range-grammar">
  <h3>
    <a href="#range-grammar" name="range-grammar" class="pilcrow"></a>
Range Grammar
  </h3>
</div>
...
<div class="pilwrap" id="ranges-1">
  <h3>
    <a href="#ranges-1" name="ranges-1" class="pilcrow"></a>
Ranges
  </h3>
</div>
<ul>
