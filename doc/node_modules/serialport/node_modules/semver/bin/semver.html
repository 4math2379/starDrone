...
<head>
  ...
  <script>
    var relativeDir = "../../../../../";
    var thisFile = "node_modules/serialport/node_modules/semver/bin/semver";
...
<span class="hljs-keyword">var</span> argv = process.argv.slice(<span class="hljs-number">2</span>)
  ...
  , lt = []
  , eq = []
  , inc = <span class="hljs-literal">null</span>
  , version = <span class="hljs-built_in">require</span>(<span class="hljs-string">"../package.json"</span>).version
  , loose = <span class="hljs-literal">false</span>
  , identifier = <span class="hljs-literal">undefined</span>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">main</span> (<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">while</span> (argv.length) {
    ...
    <span class="hljs-keyword">var</span> i = a.indexOf(<span class="hljs-string">'='</span>)
    <span class="hljs-keyword">if</span> (i !== <span class="hljs-number">-1</span>) {
      a = a.slice(<span class="hljs-number">0</span>, i)
      argv.unshift(a.slice(i + <span class="hljs-number">1</span>))
    }
  ...
  versions = versions.filter(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">v</span>) </span>{
    <span class="hljs-keyword">return</span> semver.valid(v, loose)
  })
  <span class="hljs-keyword">if</span> (!versions.length) <span class="hljs-keyword">return</span> fail()
  <span class="hljs-keyword">if</span> (inc &amp;&amp; (versions.length !== <span class="hljs-number">1</span> || range.length))
    <span class="hljs-keyword">return</span> failInc()

  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, l = range.length; i &lt; l ; i ++) {
    versions = versions.filter(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">v</span>) </span>{
      <span class="hljs-keyword">return</span> semver.satisfies(v, range[i], loose)
    })
    <span class="hljs-keyword">if</span> (!versions.length) <span class="hljs-keyword">return</span> fail()
  }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">success</span> (<span class="hljs-params"></span>) </span>{
  ...
  versions.sort(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">a, b</span>) </span>{
    <span class="hljs-keyword">return</span> semver[compare](a, b, loose)
  }).map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">v</span>) </span>{
    <span class="hljs-keyword">return</span> semver.clean(v, loose)
  }).map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">v</span>) </span>{
    <span class="hljs-keyword">return</span> inc ? semver.inc(v, inc, loose, identifier) : v
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">help</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-built_in">console</span>.log([<span class="hljs-string">"SemVer "</span> + version
              ...
              ,<span class="hljs-string">"A JavaScript implementation of the http://semver.org/ specification"</span>
