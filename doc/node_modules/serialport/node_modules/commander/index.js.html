...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/commander/index.js";
...
<span class="hljs-keyword">var</span> readlink = <span class="hljs-built_in">require</span>(<span class="hljs-string">'graceful-readlink'</span>).readlinkSync;
...
<p>Leftover arguments need to be pushed back. Fixes issue #56</p>
    ...
    self._args.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">arg, i</span>) </span>{
      <span class="hljs-keyword">if</span> (arg.required &amp;&amp; <span class="hljs-literal">null</span> == args[i]) {
...
expects</p>
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._alias) parent.on(<span class="hljs-keyword">this</span>._alias, listener);
  <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
};
...
<p>preassign default value only for --no-*, [optional], or <required></p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-literal">false</span> == option.bool || option.optional || option.required) {
</pre>
        </td>
      </tr>
...
<p>when --no-* we make sure default is true</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (<span class="hljs-literal">false</span> == option.bool) defaultValue = <span class="hljs-literal">true</span>;
</pre>
        </td>
      </tr>
...
<p>preassign only if we have a default</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (<span class="hljs-literal">undefined</span> !== defaultValue) self[name] = defaultValue;
  }
...
and conditionally invoke the callback</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">this</span>.on(oname, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">val</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>coercion</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (<span class="hljs-literal">null</span> !== val &amp;&amp; fn) val = fn(val, <span class="hljs-literal">undefined</span> === self[name]
      ? defaultValue
      : self[name]);
...
<p>unassigned or bool</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (<span class="hljs-string">'boolean'</span> == <span class="hljs-keyword">typeof</span> self[name] || <span class="hljs-string">'undefined'</span> == <span class="hljs-keyword">typeof</span> self[name]) {
</pre>
        </td>
      </tr>
...
<p>if no value, bool true, and we have a default, then use it!</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">if</span> (<span class="hljs-literal">null</span> == val) {
    ...
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-literal">null</span> !== val) {
</pre>
        </td>
      </tr>
...
<p>use the default subcommand</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    args.unshift(name = <span class="hljs-keyword">this</span>.defaultExecutable);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.executeSubCommand(argv, args, parsed.unknown);
  }
...
Command.prototype.executeSubCommand = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">argv, args, unknown</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-string">'help'</span> == args[<span class="hljs-number">0</span>] &amp;&amp; <span class="hljs-number">1</span> == args.length) <span class="hljs-keyword">this</span>.help();
...
<p><cmd> --help</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-string">'help'</span> == args[<span class="hljs-number">0</span>]) {
...
<p>name of the subcommand, link <code>pm-install</code></p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> bin = basename(f, <span class="hljs-string">'.js'</span>) + <span class="hljs-string">'-'</span> + args[<span class="hljs-number">0</span>];
...
<p>add executable arguments to spawn</p>
      ...
      proc = spawn(<span class="hljs-string">'node'</span>, args, { <span class="hljs-attr">stdio</span>: <span class="hljs-string">'inherit'</span>, <span class="hljs-attr">customFds</span>: [<span class="hljs-number">0</span>, <span class="hljs-number">1</span>, <span class="hljs-number">2</span>] });
    } <span class="hljs-keyword">else</span> {
...
<p>Honor option terminator</p>
      ...
      ret.push(arg);
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (arg.length &gt; <span class="hljs-number">1</span> &amp;&amp; <span class="hljs-string">'-'</span> == arg[<span class="hljs-number">0</span>] &amp;&amp; <span class="hljs-string">'-'</span> != arg[<span class="hljs-number">1</span>]) {
...
Command.prototype.parseArgs = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">args, unknown</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (args.length) {
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.listeners(name).length) {
      <span class="hljs-keyword">this</span>.emit(args.shift(), args, unknown);
    } <span class="hljs-keyword">else</span> {
      <span class="hljs-keyword">this</span>.emit(<span class="hljs-string">'*'</span>, args);
    }
  } <span class="hljs-keyword">else</span> {
...
<p>literal args after --</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (<span class="hljs-string">'--'</span> == arg) {
...
<p>requires arg</p>
        ...
        arg = argv[++i];
        <span class="hljs-keyword">if</span> (<span class="hljs-literal">null</span> == arg) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.optionMissingArgument(option);
        <span class="hljs-keyword">this</span>.emit(option.name(), arg);
</pre>
        </td>
      </tr>
...
<p>optional arg</p>
        ...
        <span class="hljs-keyword">if</span> (<span class="hljs-literal">null</span> == arg || (<span class="hljs-string">'-'</span> == arg[<span class="hljs-number">0</span>] &amp;&amp; <span class="hljs-string">'-'</span> != arg)) {
...
<p>bool</p>
        ...
        <span class="hljs-keyword">this</span>.emit(option.name());
      }
      <span class="hljs-keyword">continue</span>;
    }
...
<p>looks like an option</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (arg.length &gt; <span class="hljs-number">1</span> &amp;&amp; <span class="hljs-string">'-'</span> == arg[<span class="hljs-number">0</span>]) {
...
If it isn't, then it'll simply be ignored</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">if</span> (argv[i+<span class="hljs-number">1</span>] &amp;&amp; <span class="hljs-string">'-'</span> != argv[i+<span class="hljs-number">1</span>][<span class="hljs-number">0</span>]) {
...
<span class="dox_type">public</span>
  ...
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span> ; i &lt; len; i++) {
    <span class="hljs-keyword">var</span> key = camelcase(<span class="hljs-keyword">this</span>.options[i].name());
    result[key] = key === <span class="hljs-string">'version'</span> ? <span class="hljs-keyword">this</span>._version : <span class="hljs-keyword">this</span>[key];
  }
  <span class="hljs-keyword">return</span> result;
};
...
Command.prototype.version = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">str, flags</span>) </span>{
  <span class="hljs-keyword">if</span> (<span class="hljs-number">0</span> == <span class="hljs-built_in">arguments</span>.length) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._version;
  <span class="hljs-keyword">this</span>._version = str;
  flags = flags || <span class="hljs-string">'-V, --version'</span>;
  <span class="hljs-keyword">this</span>.option(flags, <span class="hljs-string">'output the version number'</span>);
  <span class="hljs-keyword">this</span>.on(<span class="hljs-string">'version'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
<span class="dox_type">public</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
Command.prototype.description = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">str</span>) </span>{
  <span class="hljs-keyword">if</span> (<span class="hljs-number">0</span> === <span class="hljs-built_in">arguments</span>.length) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._description;
...
Command.prototype.alias = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">alias</span>) </span>{
  <span class="hljs-keyword">if</span> (<span class="hljs-number">0</span> == <span class="hljs-built_in">arguments</span>.length) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._alias;
  <span class="hljs-keyword">this</span>._alias = alias;
  <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
};
...
Command.prototype.usage = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">str</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-number">0</span> == <span class="hljs-built_in">arguments</span>.length) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._usage || usage;
...
<span class="dox_type">public</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
Command.prototype.name = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
Command.prototype.largestOptionLength = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.options.reduce(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">max, option</span>) </span>{
...
<p>Prepend the help information</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> [pad(<span class="hljs-string">'-h, --help'</span>, width) + <span class="hljs-string">'  '</span> + <span class="hljs-string">'output usage information'</span>]
      .concat(<span class="hljs-keyword">this</span>.options.map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">option</span>) </span>{
...
Command.prototype.commandHelp = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">var</span> commands = <span class="hljs-keyword">this</span>.commands.filter(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">cmd</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> width = commands.reduce(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">max, command</span>) </span>{
  ...
  <span class="hljs-keyword">return</span> [
    ...
    , commands.map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">cmd</span>) </span>{
      ...
      <span class="hljs-keyword">return</span> pad(cmd[<span class="hljs-number">0</span>], width) + desc;
...
Command.prototype.helpInformation = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._description) {
    desc = [
      <span class="hljs-string">'  '</span> + <span class="hljs-keyword">this</span>._description
      , <span class="hljs-string">''</span>
    ];
  }
