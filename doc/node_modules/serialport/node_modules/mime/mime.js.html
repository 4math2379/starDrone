...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/mime/mime.js";
...
<span>(Object) type definitions
  ...
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> type <span class="hljs-keyword">in</span> map) {
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; exts.length; i++) {
      <span class="hljs-keyword">if</span> (process.env.DEBUG_MIME &amp;&amp; <span class="hljs-keyword">this</span>.types[exts]) {
        <span class="hljs-built_in">console</span>.warn(<span class="hljs-keyword">this</span>._loading.replace(<span class="hljs-regexp">/.*\//</span>, <span class="hljs-string">''</span>), <span class="hljs-string">'changes "'</span> + exts[i] + <span class="hljs-string">'" extension type from '</span> +
          <span class="hljs-keyword">this</span>.types[exts] + <span class="hljs-string">' to '</span> + type);
      }
...
<p>Assume text types are utf8</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">return</span> (<span class="hljs-regexp">/^text\//</span>).test(mimeType) ? <span class="hljs-string">'UTF-8'</span> : fallback;
  }
};
