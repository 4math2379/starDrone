...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/qs/README.md";
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> plainObject = qs.parse(<span class="hljs-string">'a[hasOwnProperty]=b'</span>, { <span class="hljs-attr">plainObjects</span>: <span class="hljs-literal">true</span> });
assert.deepEqual(plainObject, { <span class="hljs-attr">a</span>: { <span class="hljs-attr">hasOwnProperty</span>: <span class="hljs-string">'b'</span> } });
</code></pre>
