...
<head>
  ...
  <script>
    var relativeDir = "../../../../../";
    var thisFile = "node_modules/serialport/node_modules/qs/test/parse.js";
...
test(<span class="hljs-string">'parse()'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">t</span>) </span>{
    ...
    t.test(<span class="hljs-string">'transforms arrays to objects'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">st</span>) </span>{
        ...
        st.deepEqual(qs.parse(<span class="hljs-string">'a[]=b&amp;a[t]=u&amp;a[hasOwnProperty]=c'</span>), { <span class="hljs-attr">a</span>: { <span class="hljs-string">'0'</span>: <span class="hljs-string">'b'</span>, <span class="hljs-attr">t</span>: <span class="hljs-string">'u'</span>, <span class="hljs-attr">c</span>: <span class="hljs-literal">true</span> } });
        st.deepEqual(qs.parse(<span class="hljs-string">'a[]=b&amp;a[hasOwnProperty]=c&amp;a[x]=y'</span>), { <span class="hljs-attr">a</span>: { <span class="hljs-string">'0'</span>: <span class="hljs-string">'b'</span>, <span class="hljs-string">'1'</span>: <span class="hljs-string">'c'</span>, <span class="hljs-attr">x</span>: <span class="hljs-string">'y'</span> } });
        st.end();
    });
    ...
    t.test(<span class="hljs-string">'allows for empty strings in arrays'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">st</span>) </span>{
        ...
        st.deepEqual(qs.parse(<span class="hljs-string">'a[0]=b&amp;a[1]&amp;a[2]=c&amp;a[19]='</span>, { <span class="hljs-attr">strictNullHandling</span>: <span class="hljs-literal">true</span> }), { <span class="hljs-attr">a</span>: [<span class="hljs-string">'b'</span>, <span class="hljs-literal">null</span>, <span class="hljs-string">'c'</span>, <span class="hljs-string">''</span>] });
        st.deepEqual(qs.parse(<span class="hljs-string">'a[0]=b&amp;a[1]=&amp;a[2]=c&amp;a[19]'</span>, { <span class="hljs-attr">strictNullHandling</span>: <span class="hljs-literal">true</span> }), { <span class="hljs-attr">a</span>: [<span class="hljs-string">'b'</span>, <span class="hljs-string">''</span>, <span class="hljs-string">'c'</span>, <span class="hljs-literal">null</span>] });
        st.deepEqual(qs.parse(<span class="hljs-string">'a[]=&amp;a[]=b&amp;a[]=c'</span>), { <span class="hljs-attr">a</span>: [<span class="hljs-string">''</span>, <span class="hljs-string">'b'</span>, <span class="hljs-string">'c'</span>] });
        st.end();
    });
