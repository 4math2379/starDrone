...
<html>
<head>
  <title>cacheEntry.json</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../../../../../doc-style.css" />
  <script src="../../../../../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../../../../../";
    var thisFile = "node_modules/serialport/node_modules/har-validator/lib/schemas/cacheEntry.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-attr">"oneOf"</span>: [{
    ...
    <span class="hljs-attr">"required"</span>: [
      <span class="hljs-string">"lastAccess"</span>,
      <span class="hljs-string">"eTag"</span>,
      <span class="hljs-string">"hitCount"</span>
    ],
    <span class="hljs-attr">"properties"</span>: {
      <span class="hljs-attr">"expires"</span>: {
        <span class="hljs-attr">"type"</span>: <span class="hljs-string">"string"</span>
      },
      <span class="hljs-attr">"lastAccess"</span>: {
        <span class="hljs-attr">"type"</span>: <span class="hljs-string">"string"</span>
      },
      <span class="hljs-attr">"eTag"</span>: {
        <span class="hljs-attr">"type"</span>: <span class="hljs-string">"string"</span>
      },
      <span class="hljs-attr">"hitCount"</span>: {
