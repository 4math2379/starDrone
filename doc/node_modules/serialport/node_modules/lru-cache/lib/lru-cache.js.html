...
<head>
  ...
  <script>
    var relativeDir = "../../../../../";
    var thisFile = "node_modules/serialport/node_modules/lru-cache/lib/lru-cache.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-built_in">module</span>.exports = LRUCache
...
<p>use symbols if possible, otherwise just _props</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> symbols = {}
<span class="hljs-keyword">var</span> hasSymbol = <span class="hljs-keyword">typeof</span> <span class="hljs-built_in">Symbol</span> === <span class="hljs-string">'function'</span>
...
<span class="hljs-keyword">if</span> (hasSymbol) {
  makeSymbol = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key</span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-built_in">Symbol</span>.for(key)
  }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">priv</span> (<span class="hljs-params">obj, key, val</span>) </span>{
  <span class="hljs-keyword">var</span> sym
  <span class="hljs-keyword">if</span> (symbols[key]) {
    sym = symbols[key]
  } <span class="hljs-keyword">else</span> {
    sym = makeSymbol(key)
    symbols[key] = sym
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-built_in">arguments</span>.length === <span class="hljs-number">2</span>) {
    <span class="hljs-keyword">return</span> obj[sym]
  } <span class="hljs-keyword">else</span> {
    obj[sym] = val
...
the Yallist.Node object.</p>
  ...
  <span class="hljs-keyword">var</span> max = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>, options.max)
</pre>
        </td>
      </tr>
...
<p>Kind of weird to have a default max of Infinity, but oh well.</p>
    ...
    priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>, <span class="hljs-literal">Infinity</span>)
  }
  ...
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>, lc)

  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'allowStale'</span>, options.stale || <span class="hljs-literal">false</span>)
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'maxAge'</span>, options.maxAge || <span class="hljs-number">0</span>)
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>, options.dispose)
...
<p>resize the cache when the max changes.</p>
  ...
  <span class="hljs-attr">set</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">mL</span>) </span>{
    ...
    priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>, mL)
    trim(<span class="hljs-keyword">this</span>)
  },
  <span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>)
  },
...
<span class="hljs-built_in">Object</span>.defineProperty(LRUCache.prototype, <span class="hljs-string">'allowStale'</span>, {
  <span class="hljs-attr">set</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">allowStale</span>) </span>{
    priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'allowStale'</span>, !!allowStale)
  },
  <span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'allowStale'</span>)
  },
  <span class="hljs-attr">enumerable</span>: <span class="hljs-literal">true</span>
})
...
<span class="hljs-built_in">Object</span>.defineProperty(LRUCache.prototype, <span class="hljs-string">'maxAge'</span>, {
  <span class="hljs-attr">set</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">mA</span>) </span>{
    ...
    priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'maxAge'</span>, mA)
    trim(<span class="hljs-keyword">this</span>)
  },
  <span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'maxAge'</span>)
  },
  <span class="hljs-attr">enumerable</span>: <span class="hljs-literal">true</span>
})
...
<p>resize the cache when the lengthCalculator changes.</p>
  ...
  <span class="hljs-attr">set</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">lC</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (lC !== priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>)) {
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>, lC)
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>, <span class="hljs-number">0</span>)
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">hit</span>) </span>{
        hit.length = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>).call(<span class="hljs-keyword">this</span>, hit.value, hit.key)
        priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>, priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>) + hit.length)
      }, <span class="hljs-keyword">this</span>)
    }
    trim(<span class="hljs-keyword">this</span>)
  },
  <span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>) },
  <span class="hljs-attr">enumerable</span>: <span class="hljs-literal">true</span>
})

<span class="hljs-built_in">Object</span>.defineProperty(LRUCache.prototype, <span class="hljs-string">'length'</span>, {
  <span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>) },
  <span class="hljs-attr">enumerable</span>: <span class="hljs-literal">true</span>
})

<span class="hljs-built_in">Object</span>.defineProperty(LRUCache.prototype, <span class="hljs-string">'itemCount'</span>, {
  <span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).length },
  <span class="hljs-attr">enumerable</span>: <span class="hljs-literal">true</span>
})
...
LRUCache.prototype.rforEach = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn, thisp</span>) </span>{
  ...
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> walker = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).tail; walker !== <span class="hljs-literal">null</span>;) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">forEachStep</span> (<span class="hljs-params">self, fn, node, thisp</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (isStale(self, hit)) {
    del(self, node)
    <span class="hljs-keyword">if</span> (!priv(self, <span class="hljs-string">'allowStale'</span>)) {
...
LRUCache.prototype.forEach = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn, thisp</span>) </span>{
  thisp = thisp || <span class="hljs-keyword">this</span>
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> walker = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).head; walker !== <span class="hljs-literal">null</span>;) {
...
LRUCache.prototype.keys = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).toArray().map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">k</span>) </span>{
...
LRUCache.prototype.reset = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">if</span> (priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>) &amp;&amp;
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>) &amp;&amp;
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).length) {
    priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">hit</span>) </span>{
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>).call(<span class="hljs-keyword">this</span>, hit.key, hit.value)
    }, <span class="hljs-keyword">this</span>)
  }

  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>, <span class="hljs-keyword">new</span> <span class="hljs-built_in">Map</span>()) <span class="hljs-comment">// hash of items by key</span>
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>, <span class="hljs-keyword">new</span> Yallist()) <span class="hljs-comment">// list of items in order of use recency</span>
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>, <span class="hljs-number">0</span>) <span class="hljs-comment">// length of items in the list</span>
}

LRUCache.prototype.dump = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">hit</span>) </span>{
...
LRUCache.prototype.dumpLru = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">return</span> priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>)
}
...
LRUCache.prototype.inspect = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">n, opts</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> <span class="hljs-keyword">as</span> = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'allowStale'</span>)
  ...
  <span class="hljs-keyword">var</span> max = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>)
  ...
  <span class="hljs-keyword">var</span> maxAge = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'maxAge'</span>)
  ...
  <span class="hljs-keyword">var</span> lc = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>)
  <span class="hljs-keyword">if</span> (lc &amp;&amp; lc !== naiveLength) {
    <span class="hljs-keyword">if</span> (extras) {
      str += <span class="hljs-string">','</span>
    }
    str += <span class="hljs-string">'\n  length: '</span> + util.inspect(priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>), opts)
    extras = <span class="hljs-literal">true</span>
  }

  <span class="hljs-keyword">var</span> didFirst = <span class="hljs-literal">false</span>
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">item</span>) </span>{
...
LRUCache.prototype.set = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key, value, maxAge</span>) </span>{
  maxAge = maxAge || priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'maxAge'</span>)

  <span class="hljs-keyword">var</span> now = maxAge ? <span class="hljs-built_in">Date</span>.now() : <span class="hljs-number">0</span>
  <span class="hljs-keyword">var</span> len = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lengthCalculator'</span>).call(<span class="hljs-keyword">this</span>, value, key)

  <span class="hljs-keyword">if</span> (priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).has(key)) {
    <span class="hljs-keyword">if</span> (len &gt; priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>)) {
      del(<span class="hljs-keyword">this</span>, priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).get(key))
      <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>
    }

    <span class="hljs-keyword">var</span> node = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).get(key)
...
<p>dispose of the old one before overwriting</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>)) {
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>).call(<span class="hljs-keyword">this</span>, key, item.value)
    }

    item.now = now
    item.maxAge = maxAge
    item.value = value
    priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>, priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>) + (len - item.length))
    item.length = len
...
<p>oversized objects fall out of cache automatically.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (hit.length &gt; priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'max'</span>)) {
    <span class="hljs-keyword">if</span> (priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>)) {
      priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'dispose'</span>).call(<span class="hljs-keyword">this</span>, key, value)
    }
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>
  }

  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>, priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'length'</span>) + hit.length)
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).unshift(hit)
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).set(key, priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).head)
  trim(<span class="hljs-keyword">this</span>)
  <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>
}
...
LRUCache.prototype.has = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key</span>) </span>{
  <span class="hljs-keyword">if</span> (!priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).has(key)) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>
  <span class="hljs-keyword">var</span> hit = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).get(key).value
  <span class="hljs-keyword">if</span> (isStale(<span class="hljs-keyword">this</span>, hit)) {
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>
  }
  <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>
...
LRUCache.prototype.get = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key</span>) </span>{
  <span class="hljs-keyword">return</span> get(<span class="hljs-keyword">this</span>, key, <span class="hljs-literal">true</span>)
}

LRUCache.prototype.peek = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key</span>) </span>{
  <span class="hljs-keyword">return</span> get(<span class="hljs-keyword">this</span>, key, <span class="hljs-literal">false</span>)
}

LRUCache.prototype.pop = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">var</span> node = priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'lruList'</span>).tail
...
LRUCache.prototype.prune = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  ...
  priv(<span class="hljs-keyword">this</span>, <span class="hljs-string">'cache'</span>).forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, key</span>) </span>{
    get(self, key, <span class="hljs-literal">false</span>)
  })
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">get</span> (<span class="hljs-params">self, key, doUse</span>) </span>{
  <span class="hljs-keyword">var</span> node = priv(self, <span class="hljs-string">'cache'</span>).get(key)
  <span class="hljs-keyword">if</span> (node) {
    <span class="hljs-keyword">var</span> hit = node.value
    <span class="hljs-keyword">if</span> (isStale(self, hit)) {
      del(self, node)
      <span class="hljs-keyword">if</span> (!priv(self, <span class="hljs-string">'allowStale'</span>)) hit = <span class="hljs-literal">undefined</span>
    } <span class="hljs-keyword">else</span> {
      <span class="hljs-keyword">if</span> (doUse) {
        priv(self, <span class="hljs-string">'lruList'</span>).unshiftNode(node)
      }
    }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isStale</span> (<span class="hljs-params">self, hit</span>) </span>{
  <span class="hljs-keyword">if</span> (!hit || (!hit.maxAge &amp;&amp; !priv(self, <span class="hljs-string">'maxAge'</span>))) {
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>
  }
  ...
  <span class="hljs-keyword">if</span> (hit.maxAge) {
    ...
    stale = priv(self, <span class="hljs-string">'maxAge'</span>) &amp;&amp; (diff &gt; priv(self, <span class="hljs-string">'maxAge'</span>))
  }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">trim</span> (<span class="hljs-params">self</span>) </span>{
  <span class="hljs-keyword">if</span> (priv(self, <span class="hljs-string">'length'</span>) &gt; priv(self, <span class="hljs-string">'max'</span>)) {
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> walker = priv(self, <span class="hljs-string">'lruList'</span>).tail;
         priv(self, <span class="hljs-string">'length'</span>) &gt; priv(self, <span class="hljs-string">'max'</span>) &amp;&amp; walker !== <span class="hljs-literal">null</span>;) {
</pre>
        </td>
      </tr>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">del</span> (<span class="hljs-params">self, node</span>) </span>{
  <span class="hljs-keyword">if</span> (node) {
    <span class="hljs-keyword">var</span> hit = node.value
    <span class="hljs-keyword">if</span> (priv(self, <span class="hljs-string">'dispose'</span>)) {
      priv(self, <span class="hljs-string">'dispose'</span>).call(<span class="hljs-keyword">this</span>, hit.key, hit.value)
    }
    priv(self, <span class="hljs-string">'length'</span>, priv(self, <span class="hljs-string">'length'</span>) - hit.length)
    priv(self, <span class="hljs-string">'cache'</span>).delete(hit.key)
    priv(self, <span class="hljs-string">'lruList'</span>).removeNode(node)
  }
}
