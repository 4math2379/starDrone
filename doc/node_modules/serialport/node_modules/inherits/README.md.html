...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/inherits/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#note-on-version-~1.0">note on version ~1.0</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><p>Browser-friendly inheritance fully compatible with standard node.js
...
<pre><code class="js"><span class="hljs-keyword">var</span> inherits = <span class="hljs-built_in">require</span>(<span class="hljs-string">'inherits'</span>);
<span class="hljs-comment">// then use exactly as the standard one</span>
</code></pre>
<div class="pilwrap" id="note-on-version-~1.0">
  <h2>
    <a href="#note-on-version-~1.0" name="note-on-version-~1.0" class="pilcrow"></a>
note on version ~1.0
  </h2>
</div>
