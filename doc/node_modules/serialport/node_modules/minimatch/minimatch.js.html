...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/serialport/node_modules/minimatch/minimatch.js";
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">braceExpand</span> (<span class="hljs-params">pattern, options</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> pattern === <span class="hljs-string">'undefined'</span>) {
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'undefined pattern'</span>)
  }
...
<p>? =&gt; one single character</p>
  ...
  <span class="hljs-keyword">var</span> plType
...
the patternList stuff.</p>
      ...
      <span class="hljs-keyword">case</span> <span class="hljs-string">'('</span>:
        ...
        patternListStack.push({
          <span class="hljs-attr">type</span>: plType,
...
The others are (?:<pattern>)<type></p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">switch</span> (plType) {
          <span class="hljs-keyword">case</span> <span class="hljs-string">'!'</span>:
          ...
          <span class="hljs-keyword">case</span> <span class="hljs-string">'*'</span>:
            re += plType
            <span class="hljs-keyword">break</span>
          <span class="hljs-keyword">case</span> <span class="hljs-string">'@'</span>: <span class="hljs-keyword">break</span> <span class="hljs-comment">// the default anyway</span>
        }
      <span class="hljs-keyword">continue</span>
...
| chars that were already escaped.</p>
    ...
    <span class="hljs-keyword">var</span> tail = re.slice(pl.reStart + <span class="hljs-number">3</span>)
</pre>
        </td>
      </tr>
...
<p>maybe some even number of , then maybe 1 , followed by a |</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    tail = tail.replace(<span class="hljs-regexp">/((?:\\{2})*)(\\?)\|/g</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">_, $<span class="hljs-number">1</span>, $<span class="hljs-number">2</span></span>) </span>{
