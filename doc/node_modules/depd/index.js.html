...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">containsNamespace</span>(<span class="hljs-params">str, namespace</span>) </span>{
  <span class="hljs-keyword">var</span> val = str.split(<span class="hljs-regexp">/[ ,]+/</span>)

  namespace = <span class="hljs-built_in">String</span>(namespace).toLowerCase()

  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span> ; i &lt; val.length; i++) {
    <span class="hljs-keyword">if</span> (!(str = val[i])) <span class="hljs-keyword">continue</span>;
...
<p>namespace contained</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (str === <span class="hljs-string">'*'</span> || str.toLowerCase() === namespace) {
...
<p>provided site</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    callSite = callSiteLocation(stack[<span class="hljs-number">1</span>])
...
<p>get caller of deprecated thing in relation to file</p>
  ...
  <span class="hljs-keyword">var</span> key = caller
    ? site.join(<span class="hljs-string">':'</span>) + <span class="hljs-string">'__'</span> + caller.join(<span class="hljs-string">':'</span>)
...
<p>generate automatic message from call site</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (!message) {
...
<p>emit deprecation if listeners exist</p>
    ...
    <span class="hljs-keyword">var</span> err = DeprecationError(<span class="hljs-keyword">this</span>._namespace, message, stack.slice(i))
...
<p>format and write message</p>
    ...
    ? formatColor
    : formatPlain
  <span class="hljs-keyword">var</span> msg = format.call(<span class="hljs-keyword">this</span>, message, caller, stack.slice(i))
  process.stderr.write(msg + <span class="hljs-string">'\n'</span>, <span class="hljs-string">'utf8'</span>)
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">wrapfunction</span>(<span class="hljs-params">fn, message</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> deprecatedfn = <span class="hljs-built_in">eval</span>(<span class="hljs-string">'(function ('</span> + args + <span class="hljs-string">') {\n'</span>
