...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/ms/index.js";
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">val, options</span>) </span>{
  ...
  <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'val is not a non-empty string or a valid number. val='</span> + <span class="hljs-built_in">JSON</span>.stringify(val))
}
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse</span>(<span class="hljs-params">str</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (str.length &gt; <span class="hljs-number">10000</span>) {
