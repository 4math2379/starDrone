...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/on-finished/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#on-finished">on-finished</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#onfinished-res-listener">onFinished(res, listener)</a>
      </div>

      <div class="heading h3">
        <a href="#onfinished-req-listener">onFinished(req, listener)</a>
      </div>

      <div class="heading h3">
        <a href="#onfinished.isfinished-res">onFinished.isFinished(res)</a>
      </div>

      <div class="heading h3">
        <a href="#onfinished.isfinished-req">onFinished.isFinished(req)</a>
      </div>

      <div class="heading h2">
        <a href="#special-node.js-requests">Special Node.js requests</a>
      </div>

      <div class="heading h3">
        <a href="#http-connect-method">HTTP CONNECT method</a>
      </div>

      <div class="heading h3">
        <a href="#http-upgrade-request">HTTP Upgrade request</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="on-finished">
  <h1>
    <a href="#on-finished" name="on-finished" class="pilcrow"></a>
on-finished
  </h1>
</div>
...
<pre><code class="sh">$ npm install on-finished
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">var</span> onFinished = <span class="hljs-built_in">require</span>(<span class="hljs-string">'on-finished'</span>)
</code></pre>
<div class="pilwrap" id="onfinished-res-listener">
  <h3>
    <a href="#onfinished-res-listener" name="onfinished-res-listener" class="pilcrow"></a>
...
<pre><code class="js">onFinished(res, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err, res</span>) </span>{
  <span class="hljs-comment">// clean up open fds, etc.</span>
  <span class="hljs-comment">// err contains the error is request error'd</span>
})
</code></pre>
<div class="pilwrap" id="onfinished-req-listener">
  <h3>
    <a href="#onfinished-req-listener" name="onfinished-req-listener" class="pilcrow"></a>
...
<pre><code class="js"><span class="hljs-keyword">var</span> data = <span class="hljs-string">''</span>
...
<div class="pilwrap" id="onfinished.isfinished-res">
  <h3>
    <a href="#onfinished.isfinished-res" name="onfinished.isfinished-res" class="pilcrow"></a>
...
<div class="pilwrap" id="onfinished.isfinished-req">
  <h3>
    <a href="#onfinished.isfinished-req" name="onfinished.isfinished-req" class="pilcrow"></a>
...
<div class="pilwrap" id="special-node.js-requests">
  <h2>
    <a href="#special-node.js-requests" name="special-node.js-requests" class="pilcrow"></a>
Special Node.js requests
  </h2>
</div>
<div class="pilwrap" id="http-connect-method">
  <h3>
    <a href="#http-connect-method" name="http-connect-method" class="pilcrow"></a>
HTTP CONNECT method
  </h3>
</div>
...
<div class="pilwrap" id="http-upgrade-request">
  <h3>
    <a href="#http-upgrade-request" name="http-upgrade-request" class="pilcrow"></a>
...
<pre><code class="js"><span class="hljs-keyword">var</span> destroy = <span class="hljs-built_in">require</span>(<span class="hljs-string">'destroy'</span>)
