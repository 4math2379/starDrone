...
<html>
<head>
  <title>bluebird.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../../../doc-style.css" />
  <script src="../../../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules/bluebird/js/browser/bluebird.js";
...
Features enabled: core, race, call_get, generators, map, nodeify, promisify, props, reduce, settle, some, using, timers, filter, any, each</p>
</div>
<div class="body">
</div>
</div>
...
<span class="hljs-keyword">var</span> SomePromiseArray = <span class="hljs-built_in">Promise</span>._SomePromiseArray;
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">any</span>(<span class="hljs-params">promises</span>) </span>{
    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> SomePromiseArray(promises);
    <span class="hljs-keyword">var</span> promise = ret.promise();
    ret.setHowMany(<span class="hljs-number">1</span>);
    ret.setUnwrap();
    ret.init();
    <span class="hljs-keyword">return</span> promise;
}

<span class="hljs-built_in">Promise</span>.any = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises</span>) </span>{
    <span class="hljs-keyword">return</span> any(promises);
};

<span class="hljs-built_in">Promise</span>.prototype.any = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> any(<span class="hljs-keyword">this</span>);
};

};

},{}],<span class="hljs-number">2</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./queue"</span>:<span class="hljs-number">26</span>,<span class="hljs-string">"./schedule"</span>:<span class="hljs-number">29</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">3</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./promise"</span>:<span class="hljs-number">22</span>}],<span class="hljs-number">5</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-keyword">var</span> cr = <span class="hljs-built_in">Object</span>.create;
<span class="hljs-keyword">if</span> (cr) {
    <span class="hljs-keyword">var</span> callerCache = cr(<span class="hljs-literal">null</span>);
    <span class="hljs-keyword">var</span> getterCache = cr(<span class="hljs-literal">null</span>);
    callerCache[<span class="hljs-string">" size"</span>] = getterCache[<span class="hljs-string">" size"</span>] = <span class="hljs-number">0</span>;
}

<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> canEvaluate = util.canEvaluate;
<span class="hljs-keyword">var</span> isIdentifier = util.isIdentifier;

<span class="hljs-keyword">var</span> getMethodCaller;
<span class="hljs-keyword">var</span> getGetter;
<span class="hljs-keyword">if</span> (!<span class="hljs-literal">true</span>) {
<span class="hljs-keyword">var</span> makeMethodCaller = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">methodName</span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Function</span>(<span class="hljs-string">"ensureMethod"</span>, <span class="hljs-string">"                                    \n\
        return function(obj) {                                               \n\
            'use strict'                                                     \n\
            var len = this.length;                                           \n\
        ...
        "</span>.replace(<span class="hljs-regexp">/methodName/g</span>, methodName))(ensureMethod);
};

<span class="hljs-keyword">var</span> makeGetter = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">propertyName</span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Function</span>(<span class="hljs-string">"obj"</span>, <span class="hljs-string">"                                             \n\
        'use strict';                                                        \n\
        return obj.propertyName;                                             \n\
        "</span>.replace(<span class="hljs-string">"propertyName"</span>, propertyName));
};

<span class="hljs-keyword">var</span> getCompiled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">name, compiler, cache</span>) </span>{
    <span class="hljs-keyword">var</span> ret = cache[name];
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> ret !== <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">if</span> (!isIdentifier(name)) {
            <span class="hljs-keyword">return</span> <span class="hljs-literal">null</span>;
        }
        ret = compiler(name);
        cache[name] = ret;
        cache[<span class="hljs-string">" size"</span>]++;
        <span class="hljs-keyword">if</span> (cache[<span class="hljs-string">" size"</span>] &gt; <span class="hljs-number">512</span>) {
            <span class="hljs-keyword">var</span> keys = <span class="hljs-built_in">Object</span>.keys(cache);
            <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-number">256</span>; ++i) <span class="hljs-keyword">delete</span> cache[keys[i]];
            cache[<span class="hljs-string">" size"</span>] = keys.length - <span class="hljs-number">256</span>;
        }
    }
    <span class="hljs-keyword">return</span> ret;
};

getMethodCaller = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">name</span>) </span>{
    <span class="hljs-keyword">return</span> getCompiled(name, makeMethodCaller, callerCache);
};

getGetter = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">name</span>) </span>{
    <span class="hljs-keyword">return</span> getCompiled(name, makeGetter, getterCache);
};
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">ensureMethod</span>(<span class="hljs-params">obj, methodName</span>) </span>{
    <span class="hljs-keyword">var</span> fn;
    <span class="hljs-keyword">if</span> (obj != <span class="hljs-literal">null</span>) fn = obj[methodName];
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">var</span> message = <span class="hljs-string">"Object "</span> + util.classString(obj) + <span class="hljs-string">" has no method '"</span> +
            util.toString(methodName) + <span class="hljs-string">"'"</span>;
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>.TypeError(message);
    }
    <span class="hljs-keyword">return</span> fn;
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">caller</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> methodName = <span class="hljs-keyword">this</span>.pop();
    <span class="hljs-keyword">var</span> fn = ensureMethod(obj, methodName);
    <span class="hljs-keyword">return</span> fn.apply(obj, <span class="hljs-keyword">this</span>);
}
<span class="hljs-built_in">Promise</span>.prototype.call = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">methodName</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-literal">true</span>) {
        <span class="hljs-keyword">if</span> (canEvaluate) {
            <span class="hljs-keyword">var</span> maybeCaller = getMethodCaller(methodName);
            <span class="hljs-keyword">if</span> (maybeCaller !== <span class="hljs-literal">null</span>) {
                <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._then(
                    maybeCaller, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, args, <span class="hljs-literal">undefined</span>);
            }
        }
    }
    args.push(methodName);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._then(caller, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, args, <span class="hljs-literal">undefined</span>);
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">namedGetter</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">return</span> obj[<span class="hljs-keyword">this</span>];
}
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">indexedGetter</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> index = +<span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">if</span> (index &lt; <span class="hljs-number">0</span>) index = <span class="hljs-built_in">Math</span>.max(<span class="hljs-number">0</span>, index + obj.length);
    <span class="hljs-keyword">return</span> obj[index];
}
<span class="hljs-built_in">Promise</span>.prototype.get = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">propertyName</span>) </span>{
    <span class="hljs-keyword">var</span> isIndex = (<span class="hljs-keyword">typeof</span> propertyName === <span class="hljs-string">"number"</span>);
    <span class="hljs-keyword">var</span> getter;
    <span class="hljs-keyword">if</span> (!isIndex) {
        <span class="hljs-keyword">if</span> (canEvaluate) {
            <span class="hljs-keyword">var</span> maybeGetter = getGetter(propertyName);
            getter = maybeGetter !== <span class="hljs-literal">null</span> ? maybeGetter : namedGetter;
        } <span class="hljs-keyword">else</span> {
            getter = namedGetter;
        }
    } <span class="hljs-keyword">else</span> {
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._then(getter, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, propertyName, <span class="hljs-literal">undefined</span>);
};
};

},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">6</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">7</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./es5"</span>:<span class="hljs-number">13</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">8</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise</span>) </span>{
...
},{<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">10</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise</span>) </span>{
...
<span class="hljs-keyword">var</span> PromiseReduce = <span class="hljs-built_in">Promise</span>.reduce;
<span class="hljs-keyword">var</span> PromiseAll = <span class="hljs-built_in">Promise</span>.all;

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">promiseAllThis</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> PromiseAll(<span class="hljs-keyword">this</span>);
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">PromiseMapSeries</span>(<span class="hljs-params">promises, fn</span>) </span>{
    <span class="hljs-keyword">return</span> PromiseReduce(promises, fn, INTERNAL, INTERNAL);
}

<span class="hljs-built_in">Promise</span>.prototype.each = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn</span>) </span>{
    <span class="hljs-keyword">return</span> PromiseReduce(<span class="hljs-keyword">this</span>, fn, INTERNAL, <span class="hljs-number">0</span>)
              ._then(promiseAllThis, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, <span class="hljs-keyword">this</span>, <span class="hljs-literal">undefined</span>);
};

<span class="hljs-built_in">Promise</span>.prototype.mapSeries = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn</span>) </span>{
    <span class="hljs-keyword">return</span> PromiseReduce(<span class="hljs-keyword">this</span>, fn, INTERNAL, INTERNAL);
};

<span class="hljs-built_in">Promise</span>.each = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises, fn</span>) </span>{
    <span class="hljs-keyword">return</span> PromiseReduce(promises, fn, INTERNAL, <span class="hljs-number">0</span>)
              ._then(promiseAllThis, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, promises, <span class="hljs-literal">undefined</span>);
};

<span class="hljs-built_in">Promise</span>.mapSeries = PromiseMapSeries;
};


},{}],<span class="hljs-number">12</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./es5"</span>:<span class="hljs-number">13</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">13</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
...
},{}],<span class="hljs-number">14</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise, INTERNAL</span>) </span>{
<span class="hljs-keyword">var</span> PromiseMap = <span class="hljs-built_in">Promise</span>.map;

<span class="hljs-built_in">Promise</span>.prototype.filter = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn, options</span>) </span>{
    <span class="hljs-keyword">return</span> PromiseMap(<span class="hljs-keyword">this</span>, fn, options, INTERNAL);
};

<span class="hljs-built_in">Promise</span>.filter = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises, fn, options</span>) </span>{
    <span class="hljs-keyword">return</span> PromiseMap(promises, fn, options, INTERNAL);
};
};

},{}],<span class="hljs-number">15</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">16</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise,
                          apiRejection,
                          INTERNAL,
                          tryConvertToPromise,
                          Proxyable,
...
<span class="hljs-keyword">var</span> <span class="hljs-built_in">TypeError</span> = errors.TypeError;
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> errorObj = util.errorObj;
<span class="hljs-keyword">var</span> tryCatch = util.tryCatch;
<span class="hljs-keyword">var</span> yieldHandlers = [];

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">promiseFromYieldHandler</span>(<span class="hljs-params">value, yieldHandlers, traceParent</span>) </span>{
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; yieldHandlers.length; ++i) {
        traceParent._pushContext();
        <span class="hljs-keyword">var</span> result = tryCatch(yieldHandlers[i])(value);
        traceParent._popContext();
        <span class="hljs-keyword">if</span> (result === errorObj) {
            traceParent._pushContext();
            <span class="hljs-keyword">var</span> ret = <span class="hljs-built_in">Promise</span>.reject(errorObj.e);
            traceParent._popContext();
            <span class="hljs-keyword">return</span> ret;
        }
        <span class="hljs-keyword">var</span> maybePromise = tryConvertToPromise(result, traceParent);
        <span class="hljs-keyword">if</span> (maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) <span class="hljs-keyword">return</span> maybePromise;
    }
    <span class="hljs-keyword">return</span> <span class="hljs-literal">null</span>;
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">PromiseSpawn</span>(<span class="hljs-params">generatorFunction, receiver, yieldHandler, stack</span>) </span>{
    <span class="hljs-keyword">if</span> (debug.cancellation()) {
        <span class="hljs-keyword">var</span> internal = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>(INTERNAL);
        <span class="hljs-keyword">var</span> _finallyPromise = <span class="hljs-keyword">this</span>._finallyPromise = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>(INTERNAL);
        <span class="hljs-keyword">this</span>._promise = internal.lastly(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
            <span class="hljs-keyword">return</span> _finallyPromise;
        });
        internal._captureStackTrace();
        internal._setOnCancel(<span class="hljs-keyword">this</span>);
    } <span class="hljs-keyword">else</span> {
    ...
    <span class="hljs-keyword">this</span>._stack = stack;
    <span class="hljs-keyword">this</span>._generatorFunction = generatorFunction;
    <span class="hljs-keyword">this</span>._receiver = receiver;
    <span class="hljs-keyword">this</span>._generator = <span class="hljs-literal">undefined</span>;
    <span class="hljs-keyword">this</span>._yieldHandlers = <span class="hljs-keyword">typeof</span> yieldHandler === <span class="hljs-string">"function"</span>
        ? [yieldHandler].concat(yieldHandlers)
        : yieldHandlers;
    <span class="hljs-keyword">this</span>._yieldedPromise = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>._cancellationPhase = <span class="hljs-literal">false</span>;
}
util.inherits(PromiseSpawn, Proxyable);

PromiseSpawn.prototype._isResolved = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._promise === <span class="hljs-literal">null</span>;
};

PromiseSpawn.prototype._cleanup = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._promise = <span class="hljs-keyword">this</span>._generator = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">if</span> (debug.cancellation() &amp;&amp; <span class="hljs-keyword">this</span>._finallyPromise !== <span class="hljs-literal">null</span>) {
        <span class="hljs-keyword">this</span>._finallyPromise._fulfill();
        <span class="hljs-keyword">this</span>._finallyPromise = <span class="hljs-literal">null</span>;
    }
};

PromiseSpawn.prototype._promiseCancelled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._isResolved()) <span class="hljs-keyword">return</span>;
    <span class="hljs-keyword">var</span> implementsReturn = <span class="hljs-keyword">typeof</span> <span class="hljs-keyword">this</span>._generator[<span class="hljs-string">"return"</span>] !== <span class="hljs-string">"undefined"</span>;

    <span class="hljs-keyword">var</span> result;
    <span class="hljs-keyword">if</span> (!implementsReturn) {
        <span class="hljs-keyword">var</span> reason = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>.CancellationError(
            <span class="hljs-string">"generator .return() sentinel"</span>);
        <span class="hljs-built_in">Promise</span>.coroutine.returnSentinel = reason;
        <span class="hljs-keyword">this</span>._promise._attachExtraTrace(reason);
        <span class="hljs-keyword">this</span>._promise._pushContext();
        result = tryCatch(<span class="hljs-keyword">this</span>._generator[<span class="hljs-string">"throw"</span>]).call(<span class="hljs-keyword">this</span>._generator,
                                                         reason);
        <span class="hljs-keyword">this</span>._promise._popContext();
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">this</span>._promise._pushContext();
        result = tryCatch(<span class="hljs-keyword">this</span>._generator[<span class="hljs-string">"return"</span>]).call(<span class="hljs-keyword">this</span>._generator,
                                                          <span class="hljs-literal">undefined</span>);
        <span class="hljs-keyword">this</span>._promise._popContext();
    }
    <span class="hljs-keyword">this</span>._cancellationPhase = <span class="hljs-literal">true</span>;
    <span class="hljs-keyword">this</span>._yieldedPromise = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>._continue(result);
};

PromiseSpawn.prototype._promiseFulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">this</span>._yieldedPromise = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>._promise._pushContext();
    <span class="hljs-keyword">var</span> result = tryCatch(<span class="hljs-keyword">this</span>._generator.next).call(<span class="hljs-keyword">this</span>._generator, value);
    <span class="hljs-keyword">this</span>._promise._popContext();
    <span class="hljs-keyword">this</span>._continue(result);
};

PromiseSpawn.prototype._promiseRejected = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">reason</span>) </span>{
    <span class="hljs-keyword">this</span>._yieldedPromise = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>._promise._attachExtraTrace(reason);
    <span class="hljs-keyword">this</span>._promise._pushContext();
    <span class="hljs-keyword">var</span> result = tryCatch(<span class="hljs-keyword">this</span>._generator[<span class="hljs-string">"throw"</span>])
        .call(<span class="hljs-keyword">this</span>._generator, reason);
    <span class="hljs-keyword">this</span>._promise._popContext();
    <span class="hljs-keyword">this</span>._continue(result);
};

PromiseSpawn.prototype._resultCancelled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._yieldedPromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">this</span>._yieldedPromise;
        <span class="hljs-keyword">this</span>._yieldedPromise = <span class="hljs-literal">null</span>;
        promise.cancel();
    }
};

PromiseSpawn.prototype.promise = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._promise;
};

PromiseSpawn.prototype._run = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._generator = <span class="hljs-keyword">this</span>._generatorFunction.call(<span class="hljs-keyword">this</span>._receiver);
    <span class="hljs-keyword">this</span>._receiver =
        <span class="hljs-keyword">this</span>._generatorFunction = <span class="hljs-literal">undefined</span>;
    <span class="hljs-keyword">this</span>._promiseFulfilled(<span class="hljs-literal">undefined</span>);
};

PromiseSpawn.prototype._continue = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">result</span>) </span>{
    <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">this</span>._promise;
    <span class="hljs-keyword">if</span> (result === errorObj) {
        <span class="hljs-keyword">this</span>._cleanup();
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._cancellationPhase) {
            <span class="hljs-keyword">return</span> promise.cancel();
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">return</span> promise._rejectCallback(result.e, <span class="hljs-literal">false</span>);
        }
    }
    ...
    <span class="hljs-keyword">if</span> (result.done === <span class="hljs-literal">true</span>) {
        ...
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._cancellationPhase) {
            ...
            <span class="hljs-keyword">return</span> promise._resolveCallback(value);
        }
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">var</span> maybePromise = tryConvertToPromise(value, <span class="hljs-keyword">this</span>._promise);
        <span class="hljs-keyword">if</span> (!(maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>)) {
            maybePromise =
                promiseFromYieldHandler(maybePromise,
                                        <span class="hljs-keyword">this</span>._yieldHandlers,
                                        <span class="hljs-keyword">this</span>._promise);
            <span class="hljs-keyword">if</span> (maybePromise === <span class="hljs-literal">null</span>) {
                <span class="hljs-keyword">this</span>._promiseRejected(
                    <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(
                        <span class="hljs-string">"A value %s was yielded that could not be treated as a promise\u000a\u000a    See http://goo.gl/MqrFmX\u000a\u000a"</span>.replace(<span class="hljs-string">"%s"</span>, value) +
                        <span class="hljs-string">"From coroutine:\u000a"</span> +
                        <span class="hljs-keyword">this</span>._stack.split(<span class="hljs-string">"\n"</span>).slice(<span class="hljs-number">1</span>, <span class="hljs-number">-7</span>).join(<span class="hljs-string">"\n"</span>)
                    )
                );
                <span class="hljs-keyword">return</span>;
            }
        ...
        <span class="hljs-keyword">if</span> (((bitField &amp; <span class="hljs-number">50397184</span>) === <span class="hljs-number">0</span>)) {
            <span class="hljs-keyword">this</span>._yieldedPromise = maybePromise;
            maybePromise._proxy(<span class="hljs-keyword">this</span>, <span class="hljs-literal">null</span>);
            ...
            <span class="hljs-built_in">Promise</span>._async.invoke(
                <span class="hljs-keyword">this</span>._promiseFulfilled, <span class="hljs-keyword">this</span>, maybePromise._value()
            );
            ...
            <span class="hljs-built_in">Promise</span>._async.invoke(
                <span class="hljs-keyword">this</span>._promiseRejected, <span class="hljs-keyword">this</span>, maybePromise._reason()
            );
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">this</span>._promiseCancelled();
        }
    }
};

<span class="hljs-built_in">Promise</span>.coroutine = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">generatorFunction, options</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> generatorFunction !== <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">"generatorFunction must be a function\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>);
    }
    <span class="hljs-keyword">var</span> yieldHandler = <span class="hljs-built_in">Object</span>(options).yieldHandler;
    <span class="hljs-keyword">var</span> PromiseSpawn$ = PromiseSpawn;
    <span class="hljs-keyword">var</span> stack = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>().stack;
    <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">var</span> generator = generatorFunction.apply(<span class="hljs-keyword">this</span>, <span class="hljs-built_in">arguments</span>);
        <span class="hljs-keyword">var</span> spawn = <span class="hljs-keyword">new</span> PromiseSpawn$(<span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, yieldHandler,
                                      stack);
        <span class="hljs-keyword">var</span> ret = spawn.promise();
        spawn._generator = generator;
        spawn._promiseFulfilled(<span class="hljs-literal">undefined</span>);
        <span class="hljs-keyword">return</span> ret;
    };
};

<span class="hljs-built_in">Promise</span>.coroutine.addYieldHandler = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">fn</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">"function"</span>) {
...
<span class="hljs-built_in">Promise</span>.spawn = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">generatorFunction</span>) </span>{
    debug.deprecated(<span class="hljs-string">"Promise.spawn()"</span>, <span class="hljs-string">"Promise.coroutine()"</span>);
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> generatorFunction !== <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">return</span> apiRejection(<span class="hljs-string">"generatorFunction must be a function\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>);
    }
    <span class="hljs-keyword">var</span> spawn = <span class="hljs-keyword">new</span> PromiseSpawn(generatorFunction, <span class="hljs-keyword">this</span>);
    <span class="hljs-keyword">var</span> ret = spawn.promise();
    spawn._run(<span class="hljs-built_in">Promise</span>.spawn);
    <span class="hljs-keyword">return</span> ret;
};
};

},{<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">17</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports =
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">18</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise,
                          PromiseArray,
                          apiRejection,
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">MappingPromiseArray</span>(<span class="hljs-params">promises, fn, limit, _filter</span>) </span>{
    <span class="hljs-keyword">this</span>.constructor$(promises);
    <span class="hljs-keyword">this</span>._promise._captureStackTrace();
    <span class="hljs-keyword">var</span> domain = getDomain();
    <span class="hljs-keyword">this</span>._callback = domain === <span class="hljs-literal">null</span> ? fn : util.domainBind(domain, fn);
    <span class="hljs-keyword">this</span>._preservedValues = _filter === INTERNAL
        ? <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>(<span class="hljs-keyword">this</span>.length())
        : <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>._limit = limit;
    <span class="hljs-keyword">this</span>._inFlight = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">this</span>._queue = [];
    <span class="hljs-keyword">async</span>.invoke(<span class="hljs-keyword">this</span>._asyncInit, <span class="hljs-keyword">this</span>, <span class="hljs-literal">undefined</span>);
}
util.inherits(MappingPromiseArray, PromiseArray);

MappingPromiseArray.prototype._asyncInit = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._init$(<span class="hljs-literal">undefined</span>, <span class="hljs-number">-2</span>);
};

MappingPromiseArray.prototype._init = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{};

MappingPromiseArray.prototype._promiseFulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, index</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> preservedValues = <span class="hljs-keyword">this</span>._preservedValues;
    <span class="hljs-keyword">var</span> limit = <span class="hljs-keyword">this</span>._limit;
    ...
    <span class="hljs-keyword">if</span> (index &lt; <span class="hljs-number">0</span>) {
        ...
        <span class="hljs-keyword">if</span> (limit &gt;= <span class="hljs-number">1</span>) {
            <span class="hljs-keyword">this</span>._inFlight--;
            <span class="hljs-keyword">this</span>._drainQueue();
            <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._isResolved()) <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
        }
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">if</span> (limit &gt;= <span class="hljs-number">1</span> &amp;&amp; <span class="hljs-keyword">this</span>._inFlight &gt;= limit) {
            values[index] = value;
            <span class="hljs-keyword">this</span>._queue.push(index);
            <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
        }
        <span class="hljs-keyword">if</span> (preservedValues !== <span class="hljs-literal">null</span>) preservedValues[index] = value;

        <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">this</span>._promise;
        <span class="hljs-keyword">var</span> callback = <span class="hljs-keyword">this</span>._callback;
        <span class="hljs-keyword">var</span> receiver = promise._boundValue();
        promise._pushContext();
        <span class="hljs-keyword">var</span> ret = tryCatch(callback).call(receiver, value, index, length);
        <span class="hljs-keyword">var</span> promiseCreated = promise._popContext();
        debug.checkForgottenReturns(
            ret,
            promiseCreated,
            preservedValues !== <span class="hljs-literal">null</span> ? <span class="hljs-string">"Promise.filter"</span> : <span class="hljs-string">"Promise.map"</span>,
            promise
        );
        <span class="hljs-keyword">if</span> (ret === errorObj) {
            <span class="hljs-keyword">this</span>._reject(ret.e);
            <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
        }

        <span class="hljs-keyword">var</span> maybePromise = tryConvertToPromise(ret, <span class="hljs-keyword">this</span>._promise);
        <span class="hljs-keyword">if</span> (maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
            maybePromise = maybePromise._target();
            <span class="hljs-keyword">var</span> bitField = maybePromise._bitField;
            ;
            <span class="hljs-keyword">if</span> (((bitField &amp; <span class="hljs-number">50397184</span>) === <span class="hljs-number">0</span>)) {
                <span class="hljs-keyword">if</span> (limit &gt;= <span class="hljs-number">1</span>) <span class="hljs-keyword">this</span>._inFlight++;
                values[index] = maybePromise;
                maybePromise._proxy(<span class="hljs-keyword">this</span>, (index + <span class="hljs-number">1</span>) * <span class="hljs-number">-1</span>);
                <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
            } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (((bitField &amp; <span class="hljs-number">33554432</span>) !== <span class="hljs-number">0</span>)) {
                ret = maybePromise._value();
            } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (((bitField &amp; <span class="hljs-number">16777216</span>) !== <span class="hljs-number">0</span>)) {
                <span class="hljs-keyword">this</span>._reject(maybePromise._reason());
                <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
            } <span class="hljs-keyword">else</span> {
                <span class="hljs-keyword">this</span>._cancel();
                <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
    ...
    <span class="hljs-keyword">if</span> (totalResolved &gt;= length) {
        <span class="hljs-keyword">if</span> (preservedValues !== <span class="hljs-literal">null</span>) {
            <span class="hljs-keyword">this</span>._filter(values, preservedValues);
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">this</span>._resolve(values);
        }
        <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
    }
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
...
MappingPromiseArray.prototype._drainQueue = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">var</span> queue = <span class="hljs-keyword">this</span>._queue;
    <span class="hljs-keyword">var</span> limit = <span class="hljs-keyword">this</span>._limit;
    <span class="hljs-keyword">var</span> values = <span class="hljs-keyword">this</span>._values;
    <span class="hljs-keyword">while</span> (queue.length &gt; <span class="hljs-number">0</span> &amp;&amp; <span class="hljs-keyword">this</span>._inFlight &lt; limit) {
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._isResolved()) <span class="hljs-keyword">return</span>;
        <span class="hljs-keyword">var</span> index = queue.pop();
        <span class="hljs-keyword">this</span>._promiseFulfilled(values[index], index);
    }
};

MappingPromiseArray.prototype._filter = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">booleans, values</span>) </span>{
    <span class="hljs-keyword">var</span> len = values.length;
    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>(len);
    <span class="hljs-keyword">var</span> j = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; len; ++i) {
        <span class="hljs-keyword">if</span> (booleans[i]) ret[j++] = values[i];
    }
    ret.length = j;
    <span class="hljs-keyword">this</span>._resolve(ret);
};

MappingPromiseArray.prototype.preservedValues = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._preservedValues;
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">map</span>(<span class="hljs-params">promises, fn, options, _filter</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">"function"</span>) {
    ...
    <span class="hljs-keyword">var</span> limit = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">if</span> (options !== <span class="hljs-literal">undefined</span>) {
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> options === <span class="hljs-string">"object"</span> &amp;&amp; options !== <span class="hljs-literal">null</span>) {
            <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> options.concurrency !== <span class="hljs-string">"number"</span>) {
                <span class="hljs-keyword">return</span> <span class="hljs-built_in">Promise</span>.reject(
                    <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">"'concurrency' must be a number but it is "</span> +
                                    util.classString(options.concurrency)));
            }
            limit = options.concurrency;
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">return</span> <span class="hljs-built_in">Promise</span>.reject(<span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(
                            <span class="hljs-string">"options argument must be an object but it is "</span> +
                             util.classString(options)));
        }
    }
    limit = <span class="hljs-keyword">typeof</span> limit === <span class="hljs-string">"number"</span> &amp;&amp;
        <span class="hljs-built_in">isFinite</span>(limit) &amp;&amp; limit &gt;= <span class="hljs-number">1</span> ? limit : <span class="hljs-number">0</span>;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> MappingPromiseArray(promises, fn, limit, _filter).promise();
}

<span class="hljs-built_in">Promise</span>.prototype.map = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn, options</span>) </span>{
    <span class="hljs-keyword">return</span> map(<span class="hljs-keyword">this</span>, fn, options, <span class="hljs-literal">null</span>);
};

<span class="hljs-built_in">Promise</span>.map = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises, fn, options, _filter</span>) </span>{
    <span class="hljs-keyword">return</span> map(promises, fn, options, _filter);
};


};

},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">19</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports =
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">20</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
...
},{<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./es5"</span>:<span class="hljs-number">13</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">21</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> <span class="hljs-keyword">async</span> = <span class="hljs-built_in">Promise</span>._async;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">spreadAdapter</span>(<span class="hljs-params">val, nodeback</span>) </span>{
    <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">if</span> (!util.isArray(val)) <span class="hljs-keyword">return</span> successAdapter.call(promise, val, nodeback);
    <span class="hljs-keyword">var</span> ret =
        tryCatch(nodeback).apply(promise._boundValue(), [<span class="hljs-literal">null</span>].concat(val));
    <span class="hljs-keyword">if</span> (ret === errorObj) {
        <span class="hljs-keyword">async</span>.throwLater(ret.e);
    }
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">successAdapter</span>(<span class="hljs-params">val, nodeback</span>) </span>{
    <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">var</span> receiver = promise._boundValue();
    <span class="hljs-keyword">var</span> ret = val === <span class="hljs-literal">undefined</span>
        ? tryCatch(nodeback).call(receiver, <span class="hljs-literal">null</span>)
        : tryCatch(nodeback).call(receiver, <span class="hljs-literal">null</span>, val);
    <span class="hljs-keyword">if</span> (ret === errorObj) {
        <span class="hljs-keyword">async</span>.throwLater(ret.e);
    }
}
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">errorAdapter</span>(<span class="hljs-params">reason, nodeback</span>) </span>{
    <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">if</span> (!reason) {
        <span class="hljs-keyword">var</span> newReason = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(reason + <span class="hljs-string">""</span>);
        newReason.cause = reason;
        reason = newReason;
    }
    <span class="hljs-keyword">var</span> ret = tryCatch(nodeback).call(promise._boundValue(), reason);
    <span class="hljs-keyword">if</span> (ret === errorObj) {
        <span class="hljs-keyword">async</span>.throwLater(ret.e);
    }
}

<span class="hljs-built_in">Promise</span>.prototype.asCallback = <span class="hljs-built_in">Promise</span>.prototype.nodeify = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">nodeback,
                                                                     options</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> nodeback == <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">var</span> adapter = successAdapter;
        <span class="hljs-keyword">if</span> (options !== <span class="hljs-literal">undefined</span> &amp;&amp; <span class="hljs-built_in">Object</span>(options).spread) {
            adapter = spreadAdapter;
        }
        <span class="hljs-keyword">this</span>._then(
            adapter,
            errorAdapter,
            <span class="hljs-literal">undefined</span>,
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">22</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
_dereq_(<span class="hljs-string">'./map.js'</span>)(<span class="hljs-built_in">Promise</span>, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug);
_dereq_(<span class="hljs-string">'./call_get.js'</span>)(<span class="hljs-built_in">Promise</span>);
_dereq_(<span class="hljs-string">'./using.js'</span>)(<span class="hljs-built_in">Promise</span>, apiRejection, tryConvertToPromise, createContext, INTERNAL, debug);
_dereq_(<span class="hljs-string">'./timers.js'</span>)(<span class="hljs-built_in">Promise</span>, INTERNAL, debug);
_dereq_(<span class="hljs-string">'./generators.js'</span>)(<span class="hljs-built_in">Promise</span>, apiRejection, INTERNAL, tryConvertToPromise, Proxyable, debug);
_dereq_(<span class="hljs-string">'./nodeify.js'</span>)(<span class="hljs-built_in">Promise</span>);
_dereq_(<span class="hljs-string">'./promisify.js'</span>)(<span class="hljs-built_in">Promise</span>, INTERNAL);
_dereq_(<span class="hljs-string">'./props.js'</span>)(<span class="hljs-built_in">Promise</span>, PromiseArray, tryConvertToPromise, apiRejection);
_dereq_(<span class="hljs-string">'./race.js'</span>)(<span class="hljs-built_in">Promise</span>, INTERNAL, tryConvertToPromise, apiRejection);
_dereq_(<span class="hljs-string">'./reduce.js'</span>)(<span class="hljs-built_in">Promise</span>, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug);
_dereq_(<span class="hljs-string">'./settle.js'</span>)(<span class="hljs-built_in">Promise</span>, PromiseArray, debug);
_dereq_(<span class="hljs-string">'./some.js'</span>)(<span class="hljs-built_in">Promise</span>, PromiseArray, apiRejection);
_dereq_(<span class="hljs-string">'./filter.js'</span>)(<span class="hljs-built_in">Promise</span>, INTERNAL);
_dereq_(<span class="hljs-string">'./each.js'</span>)(<span class="hljs-built_in">Promise</span>, INTERNAL);
_dereq_(<span class="hljs-string">'./any.js'</span>)(<span class="hljs-built_in">Promise</span>);
...
},{<span class="hljs-string">"./any.js"</span>:<span class="hljs-number">1</span>,<span class="hljs-string">"./async"</span>:<span class="hljs-number">2</span>,<span class="hljs-string">"./bind"</span>:<span class="hljs-number">3</span>,<span class="hljs-string">"./call_get.js"</span>:<span class="hljs-number">5</span>,<span class="hljs-string">"./cancel"</span>:<span class="hljs-number">6</span>,<span class="hljs-string">"./catch_filter"</span>:<span class="hljs-number">7</span>,<span class="hljs-string">"./context"</span>:<span class="hljs-number">8</span>,<span class="hljs-string">"./debuggability"</span>:<span class="hljs-number">9</span>,<span class="hljs-string">"./direct_resolve"</span>:<span class="hljs-number">10</span>,<span class="hljs-string">"./each.js"</span>:<span class="hljs-number">11</span>,<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./es5"</span>:<span class="hljs-number">13</span>,<span class="hljs-string">"./filter.js"</span>:<span class="hljs-number">14</span>,<span class="hljs-string">"./finally"</span>:<span class="hljs-number">15</span>,<span class="hljs-string">"./generators.js"</span>:<span class="hljs-number">16</span>,<span class="hljs-string">"./join"</span>:<span class="hljs-number">17</span>,<span class="hljs-string">"./map.js"</span>:<span class="hljs-number">18</span>,<span class="hljs-string">"./method"</span>:<span class="hljs-number">19</span>,<span class="hljs-string">"./nodeback"</span>:<span class="hljs-number">20</span>,<span class="hljs-string">"./nodeify.js"</span>:<span class="hljs-number">21</span>,<span class="hljs-string">"./promise_array"</span>:<span class="hljs-number">23</span>,<span class="hljs-string">"./promisify.js"</span>:<span class="hljs-number">24</span>,<span class="hljs-string">"./props.js"</span>:<span class="hljs-number">25</span>,<span class="hljs-string">"./race.js"</span>:<span class="hljs-number">27</span>,<span class="hljs-string">"./reduce.js"</span>:<span class="hljs-number">28</span>,<span class="hljs-string">"./settle.js"</span>:<span class="hljs-number">30</span>,<span class="hljs-string">"./some.js"</span>:<span class="hljs-number">31</span>,<span class="hljs-string">"./synchronous_inspection"</span>:<span class="hljs-number">32</span>,<span class="hljs-string">"./thenables"</span>:<span class="hljs-number">33</span>,<span class="hljs-string">"./timers.js"</span>:<span class="hljs-number">34</span>,<span class="hljs-string">"./using.js"</span>:<span class="hljs-number">35</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">23</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">24</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise, INTERNAL</span>) </span>{
<span class="hljs-keyword">var</span> THIS = {};
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> nodebackForPromise = _dereq_(<span class="hljs-string">"./nodeback"</span>);
<span class="hljs-keyword">var</span> withAppended = util.withAppended;
<span class="hljs-keyword">var</span> maybeWrapAsError = util.maybeWrapAsError;
<span class="hljs-keyword">var</span> canEvaluate = util.canEvaluate;
<span class="hljs-keyword">var</span> <span class="hljs-built_in">TypeError</span> = _dereq_(<span class="hljs-string">"./errors"</span>).TypeError;
<span class="hljs-keyword">var</span> defaultSuffix = <span class="hljs-string">"Async"</span>;
<span class="hljs-keyword">var</span> defaultPromisified = {<span class="hljs-attr">__isPromisified__</span>: <span class="hljs-literal">true</span>};
<span class="hljs-keyword">var</span> noCopyProps = [
    <span class="hljs-string">"arity"</span>,    <span class="hljs-string">"length"</span>,
    <span class="hljs-string">"name"</span>,
    <span class="hljs-string">"arguments"</span>,
    <span class="hljs-string">"caller"</span>,
    <span class="hljs-string">"callee"</span>,
    <span class="hljs-string">"prototype"</span>,
    <span class="hljs-string">"__isPromisified__"</span>
];
<span class="hljs-keyword">var</span> noCopyPropsPattern = <span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(<span class="hljs-string">"^(?:"</span> + noCopyProps.join(<span class="hljs-string">"|"</span>) + <span class="hljs-string">")$"</span>);

<span class="hljs-keyword">var</span> defaultFilter = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">name</span>) </span>{
    <span class="hljs-keyword">return</span> util.isIdentifier(name) &amp;&amp;
        name.charAt(<span class="hljs-number">0</span>) !== <span class="hljs-string">"_"</span> &amp;&amp;
        name !== <span class="hljs-string">"constructor"</span>;
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">propsFilter</span>(<span class="hljs-params">key</span>) </span>{
    <span class="hljs-keyword">return</span> !noCopyPropsPattern.test(key);
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isPromisified</span>(<span class="hljs-params">fn</span>) </span>{
    <span class="hljs-keyword">try</span> {
        <span class="hljs-keyword">return</span> fn.__isPromisified__ === <span class="hljs-literal">true</span>;
    }
    <span class="hljs-keyword">catch</span> (e) {
        <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
    }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">hasPromisified</span>(<span class="hljs-params">obj, key, suffix</span>) </span>{
    <span class="hljs-keyword">var</span> val = util.getDataPropertyOrDefault(obj, key + suffix,
                                            defaultPromisified);
    <span class="hljs-keyword">return</span> val ? isPromisified(val) : <span class="hljs-literal">false</span>;
}
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">checkValid</span>(<span class="hljs-params">ret, suffix, suffixRegexp</span>) </span>{
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; ret.length; i += <span class="hljs-number">2</span>) {
        <span class="hljs-keyword">var</span> key = ret[i];
        <span class="hljs-keyword">if</span> (suffixRegexp.test(key)) {
            <span class="hljs-keyword">var</span> keyWithoutAsyncSuffix = key.replace(suffixRegexp, <span class="hljs-string">""</span>);
            <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> j = <span class="hljs-number">0</span>; j &lt; ret.length; j += <span class="hljs-number">2</span>) {
                <span class="hljs-keyword">if</span> (ret[j] === keyWithoutAsyncSuffix) {
                    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">"Cannot promisify an API that has normal methods with '%s'-suffix\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>
                        .replace(<span class="hljs-string">"%s"</span>, suffix));
                }
            }
        }
    }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">promisifiableMethods</span>(<span class="hljs-params">obj, suffix, suffixRegexp, filter</span>) </span>{
    <span class="hljs-keyword">var</span> keys = util.inheritedDataKeys(obj);
    <span class="hljs-keyword">var</span> ret = [];
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; keys.length; ++i) {
        <span class="hljs-keyword">var</span> key = keys[i];
        <span class="hljs-keyword">var</span> value = obj[key];
        <span class="hljs-keyword">var</span> passesDefaultFilter = filter === defaultFilter
            ? <span class="hljs-literal">true</span> : defaultFilter(key, value, obj);
...
<span class="hljs-keyword">var</span> escapeIdentRegex = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">str</span>) </span>{
    <span class="hljs-keyword">return</span> str.replace(<span class="hljs-regexp">/([$])/</span>, <span class="hljs-string">"\\$"</span>);
};

<span class="hljs-keyword">var</span> makeNodePromisifiedEval;
<span class="hljs-keyword">if</span> (!<span class="hljs-literal">true</span>) {
<span class="hljs-keyword">var</span> switchCaseArgumentOrder = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">likelyArgumentCount</span>) </span>{
    <span class="hljs-keyword">var</span> ret = [likelyArgumentCount];
    <span class="hljs-keyword">var</span> min = <span class="hljs-built_in">Math</span>.max(<span class="hljs-number">0</span>, likelyArgumentCount - <span class="hljs-number">1</span> - <span class="hljs-number">3</span>);
    <span class="hljs-keyword">for</span>(<span class="hljs-keyword">var</span> i = likelyArgumentCount - <span class="hljs-number">1</span>; i &gt;= min; --i) {
        ret.push(i);
    }
    <span class="hljs-keyword">for</span>(<span class="hljs-keyword">var</span> i = likelyArgumentCount + <span class="hljs-number">1</span>; i &lt;= <span class="hljs-number">3</span>; ++i) {
        ret.push(i);
    }
    <span class="hljs-keyword">return</span> ret;
};

<span class="hljs-keyword">var</span> argumentSequence = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">argumentCount</span>) </span>{
    <span class="hljs-keyword">return</span> util.filledRange(argumentCount, <span class="hljs-string">"_arg"</span>, <span class="hljs-string">""</span>);
};

<span class="hljs-keyword">var</span> parameterDeclaration = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">parameterCount</span>) </span>{
    <span class="hljs-keyword">return</span> util.filledRange(
        <span class="hljs-built_in">Math</span>.max(parameterCount, <span class="hljs-number">3</span>), <span class="hljs-string">"_arg"</span>, <span class="hljs-string">""</span>);
};

<span class="hljs-keyword">var</span> parameterCount = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">fn</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn.length === <span class="hljs-string">"number"</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.max(<span class="hljs-built_in">Math</span>.min(fn.length, <span class="hljs-number">1023</span> + <span class="hljs-number">1</span>), <span class="hljs-number">0</span>);
    }
    <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>;
};

makeNodePromisifiedEval =
<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">callback, receiver, originalName, fn, _, multiArgs</span>) </span>{
    <span class="hljs-keyword">var</span> newParameterCount = <span class="hljs-built_in">Math</span>.max(<span class="hljs-number">0</span>, parameterCount(fn) - <span class="hljs-number">1</span>);
    <span class="hljs-keyword">var</span> argumentOrder = switchCaseArgumentOrder(newParameterCount);
    <span class="hljs-keyword">var</span> shouldProxyThis = <span class="hljs-keyword">typeof</span> callback === <span class="hljs-string">"string"</span> || receiver === THIS;

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">generateCallForArgumentCount</span>(<span class="hljs-params">count</span>) </span>{
        <span class="hljs-keyword">var</span> args = argumentSequence(count).join(<span class="hljs-string">", "</span>);
        <span class="hljs-keyword">var</span> comma = count &gt; <span class="hljs-number">0</span> ? <span class="hljs-string">", "</span> : <span class="hljs-string">""</span>;
        <span class="hljs-keyword">var</span> ret;
        <span class="hljs-keyword">if</span> (shouldProxyThis) {
            ret = <span class="hljs-string">"ret = callback.call(this, {{args}}, nodeback); break;\n"</span>;
        } <span class="hljs-keyword">else</span> {
            ret = receiver === <span class="hljs-literal">undefined</span>
                ? <span class="hljs-string">"ret = callback({{args}}, nodeback); break;\n"</span>
                : <span class="hljs-string">"ret = callback.call(receiver, {{args}}, nodeback); break;\n"</span>;
        }
        <span class="hljs-keyword">return</span> ret.replace(<span class="hljs-string">"{{args}}"</span>, args).replace(<span class="hljs-string">", "</span>, comma);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">generateArgumentSwitchCase</span>(<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">var</span> ret = <span class="hljs-string">""</span>;
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; argumentOrder.length; ++i) {
            ret += <span class="hljs-string">"case "</span> + argumentOrder[i] +<span class="hljs-string">":"</span> +
        ...
        default:                                                             \n\
            ...
            [CodeForCall]                                                    \n\
            break;                                                           \n\
        "</span>.replace(<span class="hljs-string">"[CodeForCall]"</span>, (shouldProxyThis
                                ? <span class="hljs-string">"ret = callback.apply(this, args);\n"</span>
                                : <span class="hljs-string">"ret = callback.apply(receiver, args);\n"</span>));
        <span class="hljs-keyword">return</span> ret;
    }

    <span class="hljs-keyword">var</span> getFunctionCode = <span class="hljs-keyword">typeof</span> callback === <span class="hljs-string">"string"</span>
                                ? (<span class="hljs-string">"this != null ? this['"</span>+callback+<span class="hljs-string">"'] : fn"</span>)
                                : <span class="hljs-string">"fn"</span>;
    <span class="hljs-keyword">var</span> body = <span class="hljs-string">"'use strict';                                                \n\
        var ret = function (Parameters) {                                    \n\
            'use strict';                                                    \n\
            var len = arguments.length;                                      \n\
            var promise = new Promise(INTERNAL);                             \n\
            promise._captureStackTrace();                                    \n\
            var nodeback = nodebackForPromise(promise, "</span> + multiArgs + <span class="hljs-string">");   \n\
            var ret;                                                         \n\
        ...
        return ret;                                                          \n\
    "</span>.replace(<span class="hljs-string">"[CodeForSwitchCase]"</span>, generateArgumentSwitchCase())
        .replace(<span class="hljs-string">"[GetFunctionCode]"</span>, getFunctionCode);
    body = body.replace(<span class="hljs-string">"Parameters"</span>, parameterDeclaration(newParameterCount));
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Function</span>(<span class="hljs-string">"Promise"</span>,
                        <span class="hljs-string">"fn"</span>,
                        <span class="hljs-string">"receiver"</span>,
                        <span class="hljs-string">"withAppended"</span>,
                        <span class="hljs-string">"maybeWrapAsError"</span>,
                        <span class="hljs-string">"nodebackForPromise"</span>,
                        <span class="hljs-string">"tryCatch"</span>,
                        <span class="hljs-string">"errorObj"</span>,
                        <span class="hljs-string">"notEnumerableProp"</span>,
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">makeNodePromisifiedClosure</span>(<span class="hljs-params">callback, receiver, _, fn, __, multiArgs</span>) </span>{
    <span class="hljs-keyword">var</span> defaultThis = (<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{<span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;})();
    <span class="hljs-keyword">var</span> method = callback;
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> method === <span class="hljs-string">"string"</span>) {
        callback = fn;
    }
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">promisified</span>(<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">var</span> _receiver = receiver;
        <span class="hljs-keyword">if</span> (receiver === THIS) _receiver = <span class="hljs-keyword">this</span>;
        <span class="hljs-keyword">var</span> promise = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>(INTERNAL);
        promise._captureStackTrace();
        <span class="hljs-keyword">var</span> cb = <span class="hljs-keyword">typeof</span> method === <span class="hljs-string">"string"</span> &amp;&amp; <span class="hljs-keyword">this</span> !== defaultThis
            ? <span class="hljs-keyword">this</span>[method] : callback;
        <span class="hljs-keyword">var</span> fn = nodebackForPromise(promise, multiArgs);
        <span class="hljs-keyword">try</span> {
            cb.apply(_receiver, withAppended(<span class="hljs-built_in">arguments</span>, fn));
        } <span class="hljs-keyword">catch</span>(e) {
            promise._rejectCallback(maybeWrapAsError(e), <span class="hljs-literal">true</span>, <span class="hljs-literal">true</span>);
        }
        <span class="hljs-keyword">if</span> (!promise._isFateSealed()) promise._setAsyncGuaranteed();
        <span class="hljs-keyword">return</span> promise;
    }
    util.notEnumerableProp(promisified, <span class="hljs-string">"__isPromisified__"</span>, <span class="hljs-literal">true</span>);
    <span class="hljs-keyword">return</span> promisified;
}

<span class="hljs-keyword">var</span> makeNodePromisified = canEvaluate
    ? makeNodePromisifiedEval
    : makeNodePromisifiedClosure;

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">promisifyAll</span>(<span class="hljs-params">obj, suffix, filter, promisifier, multiArgs</span>) </span>{
    <span class="hljs-keyword">var</span> suffixRegexp = <span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(escapeIdentRegex(suffix) + <span class="hljs-string">"$"</span>);
    <span class="hljs-keyword">var</span> methods =
        promisifiableMethods(obj, suffix, suffixRegexp, filter);

    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, len = methods.length; i &lt; len; i+= <span class="hljs-number">2</span>) {
        <span class="hljs-keyword">var</span> key = methods[i];
        <span class="hljs-keyword">var</span> fn = methods[i+<span class="hljs-number">1</span>];
        <span class="hljs-keyword">var</span> promisifiedKey = key + suffix;
        <span class="hljs-keyword">if</span> (promisifier === makeNodePromisified) {
            obj[promisifiedKey] =
                makeNodePromisified(key, THIS, key, fn, suffix, multiArgs);
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">var</span> promisified = promisifier(fn, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
                <span class="hljs-keyword">return</span> makeNodePromisified(key, THIS, key,
                                           fn, suffix, multiArgs);
            });
            util.notEnumerableProp(promisified, <span class="hljs-string">"__isPromisified__"</span>, <span class="hljs-literal">true</span>);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">promisify</span>(<span class="hljs-params">callback, receiver, multiArgs</span>) </span>{
    <span class="hljs-keyword">return</span> makeNodePromisified(callback, receiver, <span class="hljs-literal">undefined</span>,
                                callback, <span class="hljs-literal">null</span>, multiArgs);
}

<span class="hljs-built_in">Promise</span>.promisify = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn, options</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">"expecting a function but got "</span> + util.classString(fn));
    }
    <span class="hljs-keyword">if</span> (isPromisified(fn)) {
        <span class="hljs-keyword">return</span> fn;
    }
    options = <span class="hljs-built_in">Object</span>(options);
    <span class="hljs-keyword">var</span> receiver = options.context === <span class="hljs-literal">undefined</span> ? THIS : options.context;
    <span class="hljs-keyword">var</span> multiArgs = !!options.multiArgs;
    <span class="hljs-keyword">var</span> ret = promisify(fn, receiver, multiArgs);
    util.copyDescriptors(fn, ret, propsFilter);
    <span class="hljs-keyword">return</span> ret;
};

<span class="hljs-built_in">Promise</span>.promisifyAll = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">target, options</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> target !== <span class="hljs-string">"function"</span> &amp;&amp; <span class="hljs-keyword">typeof</span> target !== <span class="hljs-string">"object"</span>) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">"the target of promisifyAll must be an object or a function\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>);
    }
    options = <span class="hljs-built_in">Object</span>(options);
    <span class="hljs-keyword">var</span> multiArgs = !!options.multiArgs;
    <span class="hljs-keyword">var</span> suffix = options.suffix;
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> suffix !== <span class="hljs-string">"string"</span>) suffix = defaultSuffix;
    <span class="hljs-keyword">var</span> filter = options.filter;
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> filter !== <span class="hljs-string">"function"</span>) filter = defaultFilter;
    <span class="hljs-keyword">var</span> promisifier = options.promisifier;
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> promisifier !== <span class="hljs-string">"function"</span>) promisifier = makeNodePromisified;

    <span class="hljs-keyword">if</span> (!util.isIdentifier(suffix)) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">RangeError</span>(<span class="hljs-string">"suffix must be a valid identifier\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>);
    }

    <span class="hljs-keyword">var</span> keys = util.inheritedDataKeys(target);
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; keys.length; ++i) {
        <span class="hljs-keyword">var</span> value = target[keys[i]];
        <span class="hljs-keyword">if</span> (keys[i] !== <span class="hljs-string">"constructor"</span> &amp;&amp;
            util.isClass(value)) {
    ...
    <span class="hljs-keyword">return</span> promisifyAll(target, suffix, filter, promisifier, multiArgs);
};
};


},{<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./nodeback"</span>:<span class="hljs-number">20</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">25</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">
    Promise, PromiseArray, tryConvertToPromise, apiRejection</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> isObject = util.isObject;
<span class="hljs-keyword">var</span> es5 = _dereq_(<span class="hljs-string">"./es5"</span>);
<span class="hljs-keyword">var</span> Es6Map;
<span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">Map</span> === <span class="hljs-string">"function"</span>) Es6Map = <span class="hljs-built_in">Map</span>;

<span class="hljs-keyword">var</span> mapToEntries = (<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">var</span> index = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">var</span> size = <span class="hljs-number">0</span>;

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">extractEntry</span>(<span class="hljs-params">value, key</span>) </span>{
        <span class="hljs-keyword">this</span>[index] = value;
        <span class="hljs-keyword">this</span>[index + size] = key;
        index++;
    }

    <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">mapToEntries</span>(<span class="hljs-params">map</span>) </span>{
        size = map.size;
        index = <span class="hljs-number">0</span>;
        <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>(map.size * <span class="hljs-number">2</span>);
        map.forEach(extractEntry, ret);
        <span class="hljs-keyword">return</span> ret;
    };
})();

<span class="hljs-keyword">var</span> entriesToMap = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">entries</span>) </span>{
    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> Es6Map();
    <span class="hljs-keyword">var</span> length = entries.length / <span class="hljs-number">2</span> | <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; length; ++i) {
        <span class="hljs-keyword">var</span> key = entries[length + i];
        <span class="hljs-keyword">var</span> value = entries[i];
        ret.set(key, value);
    }
    <span class="hljs-keyword">return</span> ret;
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">PropertiesPromiseArray</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> isMap = <span class="hljs-literal">false</span>;
    <span class="hljs-keyword">var</span> entries;
    <span class="hljs-keyword">if</span> (Es6Map !== <span class="hljs-literal">undefined</span> &amp;&amp; obj <span class="hljs-keyword">instanceof</span> Es6Map) {
        entries = mapToEntries(obj);
        isMap = <span class="hljs-literal">true</span>;
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">var</span> keys = es5.keys(obj);
        <span class="hljs-keyword">var</span> len = keys.length;
        entries = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>(len * <span class="hljs-number">2</span>);
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; len; ++i) {
            <span class="hljs-keyword">var</span> key = keys[i];
            entries[i] = obj[key];
            entries[i + len] = key;
    ...
    <span class="hljs-keyword">this</span>.constructor$(entries);
    <span class="hljs-keyword">this</span>._isMap = isMap;
    <span class="hljs-keyword">this</span>._init$(<span class="hljs-literal">undefined</span>, <span class="hljs-number">-3</span>);
}
util.inherits(PropertiesPromiseArray, PromiseArray);

PropertiesPromiseArray.prototype._init = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{};

PropertiesPromiseArray.prototype._promiseFulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, index</span>) </span>{
    <span class="hljs-keyword">this</span>._values[index] = value;
    <span class="hljs-keyword">var</span> totalResolved = ++<span class="hljs-keyword">this</span>._totalResolved;
    <span class="hljs-keyword">if</span> (totalResolved &gt;= <span class="hljs-keyword">this</span>._length) {
        <span class="hljs-keyword">var</span> val;
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._isMap) {
            val = entriesToMap(<span class="hljs-keyword">this</span>._values);
        } <span class="hljs-keyword">else</span> {
            val = {};
            <span class="hljs-keyword">var</span> keyOffset = <span class="hljs-keyword">this</span>.length();
            <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, len = <span class="hljs-keyword">this</span>.length(); i &lt; len; ++i) {
                val[<span class="hljs-keyword">this</span>._values[i + keyOffset]] = <span class="hljs-keyword">this</span>._values[i];
            }
        }
        <span class="hljs-keyword">this</span>._resolve(val);
        <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
    }
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
};

PropertiesPromiseArray.prototype.shouldCopyValues = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
};

PropertiesPromiseArray.prototype.getActualLength = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">len</span>) </span>{
    <span class="hljs-keyword">return</span> len &gt;&gt; <span class="hljs-number">1</span>;
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">props</span>(<span class="hljs-params">promises</span>) </span>{
    <span class="hljs-keyword">var</span> ret;
    <span class="hljs-keyword">var</span> castValue = tryConvertToPromise(promises);

    <span class="hljs-keyword">if</span> (!isObject(castValue)) {
        <span class="hljs-keyword">return</span> apiRejection(<span class="hljs-string">"cannot await properties of a non-object\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>);
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (castValue <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        ret = castValue._then(
            <span class="hljs-built_in">Promise</span>.props, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>);
    } <span class="hljs-keyword">else</span> {
        ret = <span class="hljs-keyword">new</span> PropertiesPromiseArray(castValue).promise();
    }

    <span class="hljs-keyword">if</span> (castValue <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        ret._propagateFrom(castValue, <span class="hljs-number">2</span>);
    }
    <span class="hljs-keyword">return</span> ret;
}

<span class="hljs-built_in">Promise</span>.prototype.props = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> props(<span class="hljs-keyword">this</span>);
};

<span class="hljs-built_in">Promise</span>.props = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises</span>) </span>{
    <span class="hljs-keyword">return</span> props(promises);
};
};

},{<span class="hljs-string">"./es5"</span>:<span class="hljs-number">13</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">26</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
...
},{}],<span class="hljs-number">27</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">
    Promise, INTERNAL, tryConvertToPromise, apiRejection</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);

<span class="hljs-keyword">var</span> raceLater = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promise</span>) </span>{
    <span class="hljs-keyword">return</span> promise.then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array</span>) </span>{
        <span class="hljs-keyword">return</span> race(array, promise);
    });
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">race</span>(<span class="hljs-params">promises, parent</span>) </span>{
    <span class="hljs-keyword">var</span> maybePromise = tryConvertToPromise(promises);

    <span class="hljs-keyword">if</span> (maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        <span class="hljs-keyword">return</span> raceLater(maybePromise);
    } <span class="hljs-keyword">else</span> {
        promises = util.asArray(promises);
        <span class="hljs-keyword">if</span> (promises === <span class="hljs-literal">null</span>)
            <span class="hljs-keyword">return</span> apiRejection(<span class="hljs-string">"expecting an array or an iterable object but got "</span> + util.classString(promises));
    }

    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>(INTERNAL);
    <span class="hljs-keyword">if</span> (parent !== <span class="hljs-literal">undefined</span>) {
        ret._propagateFrom(parent, <span class="hljs-number">3</span>);
    }
    <span class="hljs-keyword">var</span> fulfill = ret._fulfill;
    <span class="hljs-keyword">var</span> reject = ret._reject;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, len = promises.length; i &lt; len; ++i) {
        <span class="hljs-keyword">var</span> val = promises[i];

        <span class="hljs-keyword">if</span> (val === <span class="hljs-literal">undefined</span> &amp;&amp; !(i <span class="hljs-keyword">in</span> promises)) {
            <span class="hljs-keyword">continue</span>;
        }

        <span class="hljs-built_in">Promise</span>.cast(val)._then(fulfill, reject, <span class="hljs-literal">undefined</span>, ret, <span class="hljs-literal">null</span>);
    }
    <span class="hljs-keyword">return</span> ret;
}
...
<span class="hljs-built_in">Promise</span>.race = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises</span>) </span>{
    <span class="hljs-keyword">return</span> race(promises, <span class="hljs-literal">undefined</span>);
};

<span class="hljs-built_in">Promise</span>.prototype.race = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> race(<span class="hljs-keyword">this</span>, <span class="hljs-literal">undefined</span>);
};

};

},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">28</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise,
                          PromiseArray,
                          apiRejection,
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">ReductionPromiseArray</span>(<span class="hljs-params">promises, fn, initialValue, _each</span>) </span>{
    <span class="hljs-keyword">this</span>.constructor$(promises);
    <span class="hljs-keyword">var</span> domain = getDomain();
    <span class="hljs-keyword">this</span>._fn = domain === <span class="hljs-literal">null</span> ? fn : util.domainBind(domain, fn);
    <span class="hljs-keyword">if</span> (initialValue !== <span class="hljs-literal">undefined</span>) {
        initialValue = <span class="hljs-built_in">Promise</span>.resolve(initialValue);
        initialValue._attachCancellationCallback(<span class="hljs-keyword">this</span>);
    }
    <span class="hljs-keyword">this</span>._initialValue = initialValue;
    <span class="hljs-keyword">this</span>._currentCancellable = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">if</span>(_each === INTERNAL) {
        <span class="hljs-keyword">this</span>._eachValues = <span class="hljs-built_in">Array</span>(<span class="hljs-keyword">this</span>._length);
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (_each === <span class="hljs-number">0</span>) {
        <span class="hljs-keyword">this</span>._eachValues = <span class="hljs-literal">null</span>;
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">this</span>._eachValues = <span class="hljs-literal">undefined</span>;
    }
    <span class="hljs-keyword">this</span>._promise._captureStackTrace();
    <span class="hljs-keyword">this</span>._init$(<span class="hljs-literal">undefined</span>, <span class="hljs-number">-5</span>);
}
util.inherits(ReductionPromiseArray, PromiseArray);

ReductionPromiseArray.prototype._gotAccum = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">accum</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._eachValues !== <span class="hljs-literal">undefined</span> &amp;&amp; 
        <span class="hljs-keyword">this</span>._eachValues !== <span class="hljs-literal">null</span> &amp;&amp; 
        accum !== INTERNAL) {
        <span class="hljs-keyword">this</span>._eachValues.push(accum);
    }
};

ReductionPromiseArray.prototype._eachComplete = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._eachValues !== <span class="hljs-literal">null</span>) {
        <span class="hljs-keyword">this</span>._eachValues.push(value);
    }
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._eachValues;
};

ReductionPromiseArray.prototype._init = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{};

ReductionPromiseArray.prototype._resolveEmptyArray = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._resolve(<span class="hljs-keyword">this</span>._eachValues !== <span class="hljs-literal">undefined</span> ? <span class="hljs-keyword">this</span>._eachValues
                                                 : <span class="hljs-keyword">this</span>._initialValue);
};

ReductionPromiseArray.prototype.shouldCopyValues = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
};

ReductionPromiseArray.prototype._resolve = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">this</span>._promise._resolveCallback(value);
    <span class="hljs-keyword">this</span>._values = <span class="hljs-literal">null</span>;
};

ReductionPromiseArray.prototype._resultCancelled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">sender</span>) </span>{
    <span class="hljs-keyword">if</span> (sender === <span class="hljs-keyword">this</span>._initialValue) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._cancel();
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._isResolved()) <span class="hljs-keyword">return</span>;
    <span class="hljs-keyword">this</span>._resultCancelled$();
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._currentCancellable <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        <span class="hljs-keyword">this</span>._currentCancellable.cancel();
    }
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._initialValue <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        <span class="hljs-keyword">this</span>._initialValue.cancel();
    }
};

ReductionPromiseArray.prototype._iterate = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">values</span>) </span>{
    <span class="hljs-keyword">this</span>._values = values;
    <span class="hljs-keyword">var</span> value;
    <span class="hljs-keyword">var</span> i;
    <span class="hljs-keyword">var</span> length = values.length;
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._initialValue !== <span class="hljs-literal">undefined</span>) {
        value = <span class="hljs-keyword">this</span>._initialValue;
        i = <span class="hljs-number">0</span>;
    } <span class="hljs-keyword">else</span> {
        value = <span class="hljs-built_in">Promise</span>.resolve(values[<span class="hljs-number">0</span>]);
        i = <span class="hljs-number">1</span>;
    }

    <span class="hljs-keyword">this</span>._currentCancellable = value;

    <span class="hljs-keyword">if</span> (!value.isRejected()) {
        <span class="hljs-keyword">for</span> (; i &lt; length; ++i) {
            <span class="hljs-keyword">var</span> ctx = {
                <span class="hljs-attr">accum</span>: <span class="hljs-literal">null</span>,
                <span class="hljs-attr">value</span>: values[i],
                <span class="hljs-attr">index</span>: i,
                <span class="hljs-attr">length</span>: length,
                <span class="hljs-attr">array</span>: <span class="hljs-keyword">this</span>
            };
            value = value._then(gotAccum, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, ctx, <span class="hljs-literal">undefined</span>);
        }
    }

    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._eachValues !== <span class="hljs-literal">undefined</span>) {
        value = value
            ._then(<span class="hljs-keyword">this</span>._eachComplete, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, <span class="hljs-keyword">this</span>, <span class="hljs-literal">undefined</span>);
    }
    value._then(completed, completed, <span class="hljs-literal">undefined</span>, value, <span class="hljs-keyword">this</span>);
};

<span class="hljs-built_in">Promise</span>.prototype.reduce = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn, initialValue</span>) </span>{
    <span class="hljs-keyword">return</span> reduce(<span class="hljs-keyword">this</span>, fn, initialValue, <span class="hljs-literal">null</span>);
};

<span class="hljs-built_in">Promise</span>.reduce = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises, fn, initialValue, _each</span>) </span>{
    <span class="hljs-keyword">return</span> reduce(promises, fn, initialValue, _each);
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">completed</span>(<span class="hljs-params">valueOrReason, array</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.isFulfilled()) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">reduce</span>(<span class="hljs-params">promises, fn, initialValue, _each</span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">"function"</span>) {
        <span class="hljs-keyword">return</span> apiRejection(<span class="hljs-string">"expecting a function but got "</span> + util.classString(fn));
    }
    <span class="hljs-keyword">var</span> array = <span class="hljs-keyword">new</span> ReductionPromiseArray(promises, fn, initialValue, _each);
    <span class="hljs-keyword">return</span> array.promise();
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">gotAccum</span>(<span class="hljs-params">accum</span>) </span>{
    <span class="hljs-keyword">this</span>.accum = accum;
    <span class="hljs-keyword">this</span>.array._gotAccum(accum);
    <span class="hljs-keyword">var</span> value = tryConvertToPromise(<span class="hljs-keyword">this</span>.value, <span class="hljs-keyword">this</span>.array._promise);
    <span class="hljs-keyword">if</span> (value <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
        <span class="hljs-keyword">this</span>.array._currentCancellable = value;
        <span class="hljs-keyword">return</span> value._then(gotValue, <span class="hljs-literal">undefined</span>, <span class="hljs-literal">undefined</span>, <span class="hljs-keyword">this</span>, <span class="hljs-literal">undefined</span>);
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">return</span> gotValue.call(<span class="hljs-keyword">this</span>, value);
    }
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">gotValue</span>(<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">var</span> array = <span class="hljs-keyword">this</span>.array;
    <span class="hljs-keyword">var</span> promise = array._promise;
    <span class="hljs-keyword">var</span> fn = tryCatch(array._fn);
    promise._pushContext();
    <span class="hljs-keyword">var</span> ret;
    <span class="hljs-keyword">if</span> (array._eachValues !== <span class="hljs-literal">undefined</span>) {
        ret = fn.call(promise._boundValue(), value, <span class="hljs-keyword">this</span>.index, <span class="hljs-keyword">this</span>.length);
    } <span class="hljs-keyword">else</span> {
        ret = fn.call(promise._boundValue(),
                              <span class="hljs-keyword">this</span>.accum, value, <span class="hljs-keyword">this</span>.index, <span class="hljs-keyword">this</span>.length);
    }
    <span class="hljs-keyword">if</span> (ret <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
    ...
    debug.checkForgottenReturns(
        ret,
        promiseCreated,
        array._eachValues !== <span class="hljs-literal">undefined</span> ? <span class="hljs-string">"Promise.each"</span> : <span class="hljs-string">"Promise.reduce"</span>,
        promise
    );
    <span class="hljs-keyword">return</span> ret;
}
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">29</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">30</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports =
    <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise, PromiseArray, debug</span>) </span>{
<span class="hljs-keyword">var</span> PromiseInspection = <span class="hljs-built_in">Promise</span>.PromiseInspection;
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">SettledPromiseArray</span>(<span class="hljs-params">values</span>) </span>{
    <span class="hljs-keyword">this</span>.constructor$(values);
}
util.inherits(SettledPromiseArray, PromiseArray);

SettledPromiseArray.prototype._promiseResolved = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">index, inspection</span>) </span>{
    <span class="hljs-keyword">this</span>._values[index] = inspection;
    <span class="hljs-keyword">var</span> totalResolved = ++<span class="hljs-keyword">this</span>._totalResolved;
    <span class="hljs-keyword">if</span> (totalResolved &gt;= <span class="hljs-keyword">this</span>._length) {
        <span class="hljs-keyword">this</span>._resolve(<span class="hljs-keyword">this</span>._values);
        <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
...
SettledPromiseArray.prototype._promiseFulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, index</span>) </span>{
    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> PromiseInspection();
    ret._bitField = <span class="hljs-number">33554432</span>;
    ret._settledValueField = value;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._promiseResolved(index, ret);
};
SettledPromiseArray.prototype._promiseRejected = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">reason, index</span>) </span>{
    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> PromiseInspection();
    ret._bitField = <span class="hljs-number">16777216</span>;
    ret._settledValueField = reason;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._promiseResolved(index, ret);
};

<span class="hljs-built_in">Promise</span>.settle = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises</span>) </span>{
    debug.deprecated(<span class="hljs-string">".settle()"</span>, <span class="hljs-string">".reflect()"</span>);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> SettledPromiseArray(promises).promise();
};

<span class="hljs-built_in">Promise</span>.prototype.settle = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-built_in">Promise</span>.settle(<span class="hljs-keyword">this</span>);
};
};

},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">31</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports =
<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise, PromiseArray, apiRejection</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> <span class="hljs-built_in">RangeError</span> = _dereq_(<span class="hljs-string">"./errors"</span>).RangeError;
<span class="hljs-keyword">var</span> AggregateError = _dereq_(<span class="hljs-string">"./errors"</span>).AggregateError;
<span class="hljs-keyword">var</span> isArray = util.isArray;
<span class="hljs-keyword">var</span> CANCELLATION = {};


<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">SomePromiseArray</span>(<span class="hljs-params">values</span>) </span>{
    <span class="hljs-keyword">this</span>.constructor$(values);
    <span class="hljs-keyword">this</span>._howMany = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">this</span>._unwrap = <span class="hljs-literal">false</span>;
    <span class="hljs-keyword">this</span>._initialized = <span class="hljs-literal">false</span>;
}
util.inherits(SomePromiseArray, PromiseArray);

SomePromiseArray.prototype._init = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>._initialized) {
        <span class="hljs-keyword">return</span>;
    }
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._howMany === <span class="hljs-number">0</span>) {
        <span class="hljs-keyword">this</span>._resolve([]);
        <span class="hljs-keyword">return</span>;
    }
    <span class="hljs-keyword">this</span>._init$(<span class="hljs-literal">undefined</span>, <span class="hljs-number">-5</span>);
    <span class="hljs-keyword">var</span> isArrayResolved = isArray(<span class="hljs-keyword">this</span>._values);
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>._isResolved() &amp;&amp;
        isArrayResolved &amp;&amp;
        <span class="hljs-keyword">this</span>._howMany &gt; <span class="hljs-keyword">this</span>._canPossiblyFulfill()) {
        <span class="hljs-keyword">this</span>._reject(<span class="hljs-keyword">this</span>._getRangeError(<span class="hljs-keyword">this</span>.length()));
    }
};

SomePromiseArray.prototype.init = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._initialized = <span class="hljs-literal">true</span>;
    <span class="hljs-keyword">this</span>._init();
};

SomePromiseArray.prototype.setUnwrap = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._unwrap = <span class="hljs-literal">true</span>;
};

SomePromiseArray.prototype.howMany = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._howMany;
};

SomePromiseArray.prototype.setHowMany = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">count</span>) </span>{
    <span class="hljs-keyword">this</span>._howMany = count;
};

SomePromiseArray.prototype._promiseFulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">this</span>._addFulfilled(value);
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._fulfilled() === <span class="hljs-keyword">this</span>.howMany()) {
        <span class="hljs-keyword">this</span>._values.length = <span class="hljs-keyword">this</span>.howMany();
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.howMany() === <span class="hljs-number">1</span> &amp;&amp; <span class="hljs-keyword">this</span>._unwrap) {
            <span class="hljs-keyword">this</span>._resolve(<span class="hljs-keyword">this</span>._values[<span class="hljs-number">0</span>]);
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">this</span>._resolve(<span class="hljs-keyword">this</span>._values);
        }
        <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
...
SomePromiseArray.prototype._promiseRejected = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">reason</span>) </span>{
    <span class="hljs-keyword">this</span>._addRejected(reason);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._checkOutcome();
};

SomePromiseArray.prototype._promiseCancelled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._values <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span> || <span class="hljs-keyword">this</span>._values == <span class="hljs-literal">null</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._cancel();
    }
    <span class="hljs-keyword">this</span>._addRejected(CANCELLATION);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._checkOutcome();
};

SomePromiseArray.prototype._checkOutcome = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.howMany() &gt; <span class="hljs-keyword">this</span>._canPossiblyFulfill()) {
        <span class="hljs-keyword">var</span> e = <span class="hljs-keyword">new</span> AggregateError();
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-keyword">this</span>.length(); i &lt; <span class="hljs-keyword">this</span>._values.length; ++i) {
            <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._values[i] !== CANCELLATION) {
                e.push(<span class="hljs-keyword">this</span>._values[i]);
            }
        }
        <span class="hljs-keyword">if</span> (e.length &gt; <span class="hljs-number">0</span>) {
            <span class="hljs-keyword">this</span>._reject(e);
        } <span class="hljs-keyword">else</span> {
            <span class="hljs-keyword">this</span>._cancel();
        }
...
SomePromiseArray.prototype._fulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._totalResolved;
};

SomePromiseArray.prototype._rejected = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._values.length - <span class="hljs-keyword">this</span>.length();
};

SomePromiseArray.prototype._addRejected = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">reason</span>) </span>{
    <span class="hljs-keyword">this</span>._values.push(reason);
};

SomePromiseArray.prototype._addFulfilled = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
    <span class="hljs-keyword">this</span>._values[<span class="hljs-keyword">this</span>._totalResolved++] = value;
};

SomePromiseArray.prototype._canPossiblyFulfill = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.length() - <span class="hljs-keyword">this</span>._rejected();
};

SomePromiseArray.prototype._getRangeError = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">count</span>) </span>{
    <span class="hljs-keyword">var</span> message = <span class="hljs-string">"Input array must contain at least "</span> +
            <span class="hljs-keyword">this</span>._howMany + <span class="hljs-string">" items but contains only "</span> + count + <span class="hljs-string">" items"</span>;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">RangeError</span>(message);
};

SomePromiseArray.prototype._resolveEmptyArray = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">this</span>._reject(<span class="hljs-keyword">this</span>._getRangeError(<span class="hljs-number">0</span>));
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">some</span>(<span class="hljs-params">promises, howMany</span>) </span>{
    <span class="hljs-keyword">if</span> ((howMany | <span class="hljs-number">0</span>) !== howMany || howMany &lt; <span class="hljs-number">0</span>) {
        <span class="hljs-keyword">return</span> apiRejection(<span class="hljs-string">"expecting a positive integer\u000a\u000a    See http://goo.gl/MqrFmX\u000a"</span>);
    }
    <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> SomePromiseArray(promises);
    <span class="hljs-keyword">var</span> promise = ret.promise();
...
<span class="hljs-built_in">Promise</span>.some = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promises, howMany</span>) </span>{
    <span class="hljs-keyword">return</span> some(promises, howMany);
};

<span class="hljs-built_in">Promise</span>.prototype.some = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">howMany</span>) </span>{
    <span class="hljs-keyword">return</span> some(<span class="hljs-keyword">this</span>, howMany);
};

<span class="hljs-built_in">Promise</span>._SomePromiseArray = SomePromiseArray;
};

},{<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">32</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise</span>) </span>{
...
},{}],<span class="hljs-number">33</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise, INTERNAL</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> errorObj = util.errorObj;
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">34</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Promise, INTERNAL, debug</span>) </span>{
<span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
<span class="hljs-keyword">var</span> TimeoutError = <span class="hljs-built_in">Promise</span>.TimeoutError;

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">HandleWrapper</span>(<span class="hljs-params">handle</span>)  </span>{
    <span class="hljs-keyword">this</span>.handle = handle;
}

HandleWrapper.prototype._resultCancelled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    clearTimeout(<span class="hljs-keyword">this</span>.handle);
};

<span class="hljs-keyword">var</span> afterValue = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value</span>) </span>{ <span class="hljs-keyword">return</span> delay(+<span class="hljs-keyword">this</span>).thenReturn(value); };
<span class="hljs-keyword">var</span> delay = <span class="hljs-built_in">Promise</span>.delay = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">ms, value</span>) </span>{
    <span class="hljs-keyword">var</span> ret;
    <span class="hljs-keyword">var</span> handle;
    <span class="hljs-keyword">if</span> (value !== <span class="hljs-literal">undefined</span>) {
        ret = <span class="hljs-built_in">Promise</span>.resolve(value)
                ._then(afterValue, <span class="hljs-literal">null</span>, <span class="hljs-literal">null</span>, ms, <span class="hljs-literal">undefined</span>);
        <span class="hljs-keyword">if</span> (debug.cancellation() &amp;&amp; value <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
            ret._setOnCancel(value);
        }
    } <span class="hljs-keyword">else</span> {
        ret = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>(INTERNAL);
        handle = setTimeout(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{ ret._fulfill(); }, +ms);
        <span class="hljs-keyword">if</span> (debug.cancellation()) {
            ret._setOnCancel(<span class="hljs-keyword">new</span> HandleWrapper(handle));
        }
        ret._captureStackTrace();
    }
    ret._setAsyncGuaranteed();
...
<span class="hljs-built_in">Promise</span>.prototype.delay = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">ms</span>) </span>{
    <span class="hljs-keyword">return</span> delay(ms, <span class="hljs-keyword">this</span>);
};

<span class="hljs-keyword">var</span> afterTimeout = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">promise, message, parent</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> message !== <span class="hljs-string">"string"</span>) {
        <span class="hljs-keyword">if</span> (message <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Error</span>) {
            ...
            err = <span class="hljs-keyword">new</span> TimeoutError(<span class="hljs-string">"operation timed out"</span>);
        }
    } <span class="hljs-keyword">else</span> {
        err = <span class="hljs-keyword">new</span> TimeoutError(message);
    }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">successClear</span>(<span class="hljs-params">value</span>) </span>{
    clearTimeout(<span class="hljs-keyword">this</span>.handle);
    <span class="hljs-keyword">return</span> value;
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">failureClear</span>(<span class="hljs-params">reason</span>) </span>{
    clearTimeout(<span class="hljs-keyword">this</span>.handle);
    <span class="hljs-keyword">throw</span> reason;
}

<span class="hljs-built_in">Promise</span>.prototype.timeout = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">ms, message</span>) </span>{
    ms = +ms;
    <span class="hljs-keyword">var</span> ret, parent;

    <span class="hljs-keyword">var</span> handleWrapper = <span class="hljs-keyword">new</span> HandleWrapper(setTimeout(<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">timeoutTimeout</span>(<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">if</span> (ret.isPending()) {
            afterTimeout(ret, message, parent);
        }
    }, ms));

    <span class="hljs-keyword">if</span> (debug.cancellation()) {
        parent = <span class="hljs-keyword">this</span>.then();
        ret = parent._then(successClear, failureClear,
                            <span class="hljs-literal">undefined</span>, handleWrapper, <span class="hljs-literal">undefined</span>);
        ret._setOnCancel(handleWrapper);
    } <span class="hljs-keyword">else</span> {
        ret = <span class="hljs-keyword">this</span>._then(successClear, failureClear,
                            <span class="hljs-literal">undefined</span>, handleWrapper, <span class="hljs-literal">undefined</span>);
    }
...
},{<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">35</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">Promise, apiRejection, tryConvertToPromise,
    createContext, INTERNAL, debug</span>) </span>{
    <span class="hljs-keyword">var</span> util = _dereq_(<span class="hljs-string">"./util"</span>);
    <span class="hljs-keyword">var</span> <span class="hljs-built_in">TypeError</span> = _dereq_(<span class="hljs-string">"./errors"</span>).TypeError;
    <span class="hljs-keyword">var</span> inherits = _dereq_(<span class="hljs-string">"./util"</span>).inherits;
    <span class="hljs-keyword">var</span> errorObj = util.errorObj;
    <span class="hljs-keyword">var</span> tryCatch = util.tryCatch;
    <span class="hljs-keyword">var</span> NULL = {};

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">thrower</span>(<span class="hljs-params">e</span>) </span>{
        setTimeout(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>)</span>{<span class="hljs-keyword">throw</span> e;}, <span class="hljs-number">0</span>);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">castPreservingDisposable</span>(<span class="hljs-params">thenable</span>) </span>{
        <span class="hljs-keyword">var</span> maybePromise = tryConvertToPromise(thenable);
        <span class="hljs-keyword">if</span> (maybePromise !== thenable &amp;&amp;
            <span class="hljs-keyword">typeof</span> thenable._isDisposable === <span class="hljs-string">"function"</span> &amp;&amp;
            <span class="hljs-keyword">typeof</span> thenable._getDisposer === <span class="hljs-string">"function"</span> &amp;&amp;
            thenable._isDisposable()) {
            maybePromise._setDisposable(thenable._getDisposer());
        }
        <span class="hljs-keyword">return</span> maybePromise;
    }
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">dispose</span>(<span class="hljs-params">resources, inspection</span>) </span>{
        <span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>;
        <span class="hljs-keyword">var</span> len = resources.length;
        <span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>(INTERNAL);
        <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">iterator</span>(<span class="hljs-params"></span>) </span>{
            <span class="hljs-keyword">if</span> (i &gt;= len) <span class="hljs-keyword">return</span> ret._fulfill();
            <span class="hljs-keyword">var</span> maybePromise = castPreservingDisposable(resources[i++]);
            <span class="hljs-keyword">if</span> (maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span> &amp;&amp;
                ...
                <span class="hljs-keyword">try</span> {
                    ...
                    <span class="hljs-keyword">return</span> thrower(e);
                }
                <span class="hljs-keyword">if</span> (maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
                    <span class="hljs-keyword">return</span> maybePromise._then(iterator, thrower,
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Disposer</span>(<span class="hljs-params">data, promise, context</span>) </span>{
        <span class="hljs-keyword">this</span>._data = data;
        <span class="hljs-keyword">this</span>._promise = promise;
        <span class="hljs-keyword">this</span>._context = context;
    }

    Disposer.prototype.data = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._data;
    };

    Disposer.prototype.promise = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._promise;
    };

    Disposer.prototype.resource = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.promise().isFulfilled()) {
            <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.promise().value();
        }
        <span class="hljs-keyword">return</span> NULL;
    };

    Disposer.prototype.tryDispose = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">inspection</span>) </span>{
        <span class="hljs-keyword">var</span> resource = <span class="hljs-keyword">this</span>.resource();
        <span class="hljs-keyword">var</span> context = <span class="hljs-keyword">this</span>._context;
        <span class="hljs-keyword">if</span> (context !== <span class="hljs-literal">undefined</span>) context._pushContext();
        <span class="hljs-keyword">var</span> ret = resource !== NULL
            ? <span class="hljs-keyword">this</span>.doDispose(resource, inspection) : <span class="hljs-literal">null</span>;
        <span class="hljs-keyword">if</span> (context !== <span class="hljs-literal">undefined</span>) context._popContext();
        <span class="hljs-keyword">this</span>._promise._unsetDisposable();
        <span class="hljs-keyword">this</span>._data = <span class="hljs-literal">null</span>;
        <span class="hljs-keyword">return</span> ret;
    };

    Disposer.isDisposer = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">d</span>) </span>{
        <span class="hljs-keyword">return</span> (d != <span class="hljs-literal">null</span> &amp;&amp;
                <span class="hljs-keyword">typeof</span> d.resource === <span class="hljs-string">"function"</span> &amp;&amp;
                <span class="hljs-keyword">typeof</span> d.tryDispose === <span class="hljs-string">"function"</span>);
    };

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">FunctionDisposer</span>(<span class="hljs-params">fn, promise, context</span>) </span>{
        <span class="hljs-keyword">this</span>.constructor$(fn, promise, context);
    }
    inherits(FunctionDisposer, Disposer);

    FunctionDisposer.prototype.doDispose = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">resource, inspection</span>) </span>{
        <span class="hljs-keyword">var</span> fn = <span class="hljs-keyword">this</span>.data();
        <span class="hljs-keyword">return</span> fn.call(resource, resource, inspection);
    };

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">maybeUnwrapDisposer</span>(<span class="hljs-params">value</span>) </span>{
        <span class="hljs-keyword">if</span> (Disposer.isDisposer(value)) {
            <span class="hljs-keyword">this</span>.resources[<span class="hljs-keyword">this</span>.index]._setDisposable(value);
            <span class="hljs-keyword">return</span> value.promise();
        }
        <span class="hljs-keyword">return</span> value;
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">ResourceList</span>(<span class="hljs-params">length</span>) </span>{
        <span class="hljs-keyword">this</span>.length = length;
        <span class="hljs-keyword">this</span>.promise = <span class="hljs-literal">null</span>;
        <span class="hljs-keyword">this</span>[length<span class="hljs-number">-1</span>] = <span class="hljs-literal">null</span>;
    }

    ResourceList.prototype._resultCancelled = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
        ...
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; len; ++i) {
            ...
            <span class="hljs-keyword">if</span> (item <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
                item.cancel();
            }
        }
    };

    <span class="hljs-built_in">Promise</span>.using = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">var</span> len = <span class="hljs-built_in">arguments</span>.length;
        <span class="hljs-keyword">if</span> (len &lt; <span class="hljs-number">2</span>) <span class="hljs-keyword">return</span> apiRejection(
                        <span class="hljs-string">"you must pass at least 2 arguments to Promise.using"</span>);
        <span class="hljs-keyword">var</span> fn = <span class="hljs-built_in">arguments</span>[len - <span class="hljs-number">1</span>];
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">"function"</span>) {
            <span class="hljs-keyword">return</span> apiRejection(<span class="hljs-string">"expecting a function but got "</span> + util.classString(fn));
        }
        <span class="hljs-keyword">var</span> input;
        <span class="hljs-keyword">var</span> spreadArgs = <span class="hljs-literal">true</span>;
        <span class="hljs-keyword">if</span> (len === <span class="hljs-number">2</span> &amp;&amp; <span class="hljs-built_in">Array</span>.isArray(<span class="hljs-built_in">arguments</span>[<span class="hljs-number">0</span>])) {
            input = <span class="hljs-built_in">arguments</span>[<span class="hljs-number">0</span>];
            len = input.length;
            spreadArgs = <span class="hljs-literal">false</span>;
        } <span class="hljs-keyword">else</span> {
            input = <span class="hljs-built_in">arguments</span>;
            len--;
        }
        <span class="hljs-keyword">var</span> resources = <span class="hljs-keyword">new</span> ResourceList(len);
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; len; ++i) {
            <span class="hljs-keyword">var</span> resource = input[i];
            <span class="hljs-keyword">if</span> (Disposer.isDisposer(resource)) {
                <span class="hljs-keyword">var</span> disposer = resource;
                resource = resource.promise();
                resource._setDisposable(disposer);
            } <span class="hljs-keyword">else</span> {
                <span class="hljs-keyword">var</span> maybePromise = tryConvertToPromise(resource);
                <span class="hljs-keyword">if</span> (maybePromise <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Promise</span>) {
                    resource =
                        maybePromise._then(maybeUnwrapDisposer, <span class="hljs-literal">null</span>, <span class="hljs-literal">null</span>, {
                            <span class="hljs-attr">resources</span>: resources,
                            <span class="hljs-attr">index</span>: i
                    }, <span class="hljs-literal">undefined</span>);
                }
            }
        ...
        <span class="hljs-keyword">var</span> reflectedResources = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>(resources.length);
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; reflectedResources.length; ++i) {
            reflectedResources[i] = <span class="hljs-built_in">Promise</span>.resolve(resources[i]).reflect();
        }

        <span class="hljs-keyword">var</span> resultPromise = <span class="hljs-built_in">Promise</span>.all(reflectedResources)
            .then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">inspections</span>) </span>{
                <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; inspections.length; ++i) {
                    <span class="hljs-keyword">var</span> inspection = inspections[i];
                    <span class="hljs-keyword">if</span> (inspection.isRejected()) {
                        errorObj.e = inspection.error();
                        <span class="hljs-keyword">return</span> errorObj;
                    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (!inspection.isFulfilled()) {
                ...
                fn = tryCatch(fn);
                <span class="hljs-keyword">var</span> ret = spreadArgs
                    ? fn.apply(<span class="hljs-literal">undefined</span>, inspections) : fn(inspections);
                <span class="hljs-keyword">var</span> promiseCreated = promise._popContext();
                debug.checkForgottenReturns(
                    ret, promiseCreated, <span class="hljs-string">"Promise.using"</span>, promise);
                <span class="hljs-keyword">return</span> ret;
            });

        <span class="hljs-keyword">var</span> promise = resultPromise.lastly(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
            <span class="hljs-keyword">var</span> inspection = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Promise</span>.PromiseInspection(resultPromise);
            <span class="hljs-keyword">return</span> dispose(resources, inspection);
        });
    ...
    <span class="hljs-built_in">Promise</span>.prototype._setDisposable = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">disposer</span>) </span>{
        <span class="hljs-keyword">this</span>._bitField = <span class="hljs-keyword">this</span>._bitField | <span class="hljs-number">131072</span>;
        <span class="hljs-keyword">this</span>._disposer = disposer;
    };

    <span class="hljs-built_in">Promise</span>.prototype._isDisposable = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">return</span> (<span class="hljs-keyword">this</span>._bitField &amp; <span class="hljs-number">131072</span>) &gt; <span class="hljs-number">0</span>;
    };

    <span class="hljs-built_in">Promise</span>.prototype._getDisposer = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>._disposer;
    };

    <span class="hljs-built_in">Promise</span>.prototype._unsetDisposable = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">this</span>._bitField = <span class="hljs-keyword">this</span>._bitField &amp; (~<span class="hljs-number">131072</span>);
        <span class="hljs-keyword">this</span>._disposer = <span class="hljs-literal">undefined</span>;
    };

    <span class="hljs-built_in">Promise</span>.prototype.disposer = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fn</span>) </span>{
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn === <span class="hljs-string">"function"</span>) {
            <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> FunctionDisposer(fn, <span class="hljs-keyword">this</span>, createContext());
        }
...
},{<span class="hljs-string">"./errors"</span>:<span class="hljs-number">12</span>,<span class="hljs-string">"./util"</span>:<span class="hljs-number">36</span>}],<span class="hljs-number">36</span>:[<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">_dereq_,module,exports</span>)</span>{
<span class="hljs-meta">"use strict"</span>;
<span class="hljs-keyword">var</span> es5 = _dereq_(<span class="hljs-string">"./es5"</span>);
...
},{<span class="hljs-string">"./es5"</span>:<span class="hljs-number">13</span>}]},{},[<span class="hljs-number">4</span>])(<span class="hljs-number">4</span>)
