...
<head>
  ...
  <script>
    var relativeDir = "../../../../../../";
    var thisFile = "node_modules/send/node_modules/debug/node_modules/ms/index.js";
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">val, options</span>)</span>{
  ...
  <span class="hljs-keyword">return</span> options.long
    ? long(val)
    : short(val);
};
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse</span>(<span class="hljs-params">str</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (str.length &gt; <span class="hljs-number">10000</span>) <span class="hljs-keyword">return</span>;
  <span class="hljs-keyword">var</span> match = <span class="hljs-regexp">/^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i</span>.exec(str);
...
<span class="dox_type">private</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">short</span>(<span class="hljs-params">ms</span>) </span>{
  <span class="hljs-keyword">if</span> (ms &gt;= d) <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.round(ms / d) + <span class="hljs-string">'d'</span>;
  <span class="hljs-keyword">if</span> (ms &gt;= h) <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.round(ms / h) + <span class="hljs-string">'h'</span>;
  <span class="hljs-keyword">if</span> (ms &gt;= m) <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.round(ms / m) + <span class="hljs-string">'m'</span>;
  <span class="hljs-keyword">if</span> (ms &gt;= s) <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.round(ms / s) + <span class="hljs-string">'s'</span>;
...
<span class="dox_type">private</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">long</span>(<span class="hljs-params">ms</span>) </span>{
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">plural</span>(<span class="hljs-params">ms, n, name</span>) </span>{
  <span class="hljs-keyword">if</span> (ms &lt; n) <span class="hljs-keyword">return</span>;
  <span class="hljs-keyword">if</span> (ms &lt; n * <span class="hljs-number">1.5</span>) <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.floor(ms / n) + <span class="hljs-string">' '</span> + name;
