...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/debug/src/browser.js";
...
<div class="dox">
<div class="summary">
<p>This is the web browser implementation of <code>debug()</code>.</p>
</div>
<div class="body">
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
exports.colors = [
  <span class="hljs-string">'lightseagreen'</span>,
  <span class="hljs-string">'forestgreen'</span>,
  <span class="hljs-string">'goldenrod'</span>,
  <span class="hljs-string">'dodgerblue'</span>,
  <span class="hljs-string">'darkorchid'</span>,
...
explicitly</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">window</span> !== <span class="hljs-string">'undefined'</span> &amp;&amp; <span class="hljs-built_in">window</span> &amp;&amp; <span class="hljs-keyword">typeof</span> <span class="hljs-built_in">window</span>.process !== <span class="hljs-string">'undefined'</span> &amp;&amp; <span class="hljs-built_in">window</span>.process.type === <span class="hljs-string">'renderer'</span>) {
...
document is undefined in react-native: https://github.com/facebook/react-native/pull/1632</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">document</span> !== <span class="hljs-string">'undefined'</span> &amp;&amp; <span class="hljs-built_in">document</span> &amp;&amp; <span class="hljs-string">'WebkitAppearance'</span> <span class="hljs-keyword">in</span> <span class="hljs-built_in">document</span>.documentElement.style) ||
</pre>
        </td>
      </tr>
...
<p>is firebug? http://stackoverflow.com/a/398120/376773</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">window</span> !== <span class="hljs-string">'undefined'</span> &amp;&amp; <span class="hljs-built_in">window</span> &amp;&amp; <span class="hljs-built_in">window</span>.console &amp;&amp; (<span class="hljs-built_in">console</span>.firebug || (<span class="hljs-built_in">console</span>.exception &amp;&amp; <span class="hljs-built_in">console</span>.table))) ||
</pre>
        </td>
      </tr>
...
https://developer.mozilla.org/en-US/docs/Tools/Web_Console#Styling_messages</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    (<span class="hljs-keyword">typeof</span> navigator !== <span class="hljs-string">'undefined'</span> &amp;&amp; navigator &amp;&amp; navigator.userAgent &amp;&amp; navigator.userAgent.toLowerCase().match(<span class="hljs-regexp">/firefox\/(\d+)/</span>) &amp;&amp; <span class="hljs-built_in">parseInt</span>(<span class="hljs-built_in">RegExp</span>.$<span class="hljs-number">1</span>, <span class="hljs-number">10</span>) &gt;= <span class="hljs-number">31</span>) ||
</pre>
        </td>
      </tr>
...
<p>double check webkit in userAgent just in case we are in a worker</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    (<span class="hljs-keyword">typeof</span> navigator !== <span class="hljs-string">'undefined'</span> &amp;&amp; navigator &amp;&amp; navigator.userAgent &amp;&amp; navigator.userAgent.toLowerCase().match(<span class="hljs-regexp">/applewebkit\/(\d+)/</span>));
}
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">load</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">try</span> {
    <span class="hljs-keyword">return</span> exports.storage.debug;
  } <span class="hljs-keyword">catch</span>(e) {}
...
<p>If debug isn't set in LS, and we're in Electron, try to load $DEBUG</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> process !== <span class="hljs-string">'undefined'</span> &amp;&amp; <span class="hljs-string">'env'</span> <span class="hljs-keyword">in</span> process) {
