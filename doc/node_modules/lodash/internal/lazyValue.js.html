...
<html>
<head>
  <title>lazyValue.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../../doc-style.css" />
  <script src="../../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/lodash/internal/lazyValue.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> baseWrapperValue = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./baseWrapperValue'</span>),
    getView = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./getView'</span>),
...
<div class="details">
  ...
  <span class="hljs-keyword">if</span> (!isArr || arrLength &lt; LARGE_ARRAY_SIZE || (arrLength == length &amp;&amp; takeCount == length)) {
