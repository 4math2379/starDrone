...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/lodash/string/templateSettings.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> <span class="hljs-built_in">escape</span> = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./escape'</span>),
    reEscape = <span class="hljs-built_in">require</span>(<span class="hljs-string">'../internal/reEscape'</span>),
    reEvaluate = <span class="hljs-built_in">require</span>(<span class="hljs-string">'../internal/reEvaluate'</span>),
    reInterpolate = <span class="hljs-built_in">require</span>(<span class="hljs-string">'../internal/reInterpolate'</span>);
