...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/etag/index.js";
...
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> base64PadCharRegExp = <span class="hljs-regexp">/=+$/</span>
...
<p>fast-path empty</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">return</span> <span class="hljs-string">'"0-1B2M2Y8AsgTpgAmY7PhCfg"'</span>
  }
...
<p>compute hash of entity</p>
    ...
    .replace(base64PadCharRegExp, <span class="hljs-string">''</span>)
