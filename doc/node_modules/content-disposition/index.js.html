...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/content-disposition/index.js";
...
CHAR        = &lt;any US-ASCII character (octets 0 - 127)&gt;</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> QESC_REGEXP = <span class="hljs-regexp">/\\([\u0000-\u007f])/g</span>
...
<p>to binary string</p>
  ...
  <span class="hljs-keyword">switch</span> (charset) {
    ...
    <span class="hljs-keyword">case</span> <span class="hljs-string">'utf-8'</span>:
      value = <span class="hljs-keyword">new</span> Buffer(binary, <span class="hljs-string">'binary'</span>).toString(<span class="hljs-string">'utf8'</span>)
      <span class="hljs-keyword">break</span>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">pencode</span> (<span class="hljs-params">char</span>) </span>{
  <span class="hljs-keyword">var</span> hex = <span class="hljs-built_in">String</span>(char)
    .charCodeAt(<span class="hljs-number">0</span>)
    .toString(<span class="hljs-number">16</span>)
    .toUpperCase()
  <span class="hljs-keyword">return</span> hex.length === <span class="hljs-number">1</span>
    ? <span class="hljs-string">'%0'</span> + hex
    : <span class="hljs-string">'%'</span> + hex
}
